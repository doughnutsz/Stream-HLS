...
module attributes {torch.debug_module_name = "mvt"} {
  ...
  func.func @node2(%arg0: !dataflow.stream<f32, 160000>, %arg1: memref<400xf32>, %arg2: !dataflow.stream<f32, 400>, %arg3: f32) {
    %alloc = memref.alloc() {alignment = 64 : i64} : memref<400xf32>
    affine.for %arg4 = 0 to 400 {
      affine.for %arg5 = 0 to 400 {
        %0 = dataflow.stream_read %arg0 : (!dataflow.stream<f32, 160000>) -> f32
        %1 = affine.load %arg1[%arg4] : memref<400xf32>
        affine.if #set(%arg4) {
          affine.store %arg3, %alloc[%arg5] : memref<400xf32>
        }
        %2 = affine.load %alloc[%arg5] : memref<400xf32>
        %3 = arith.mulf %0, %1 : f32
        %4 = arith.addf %2, %3 : f32
        affine.store %4, %alloc[%arg5] : memref<400xf32>
        affine.if #set1(%arg4) {
          %5 = affine.load %alloc[%arg5] : memref<400xf32>
  ...
  func.func @node3(%arg0: memref<400x400xf32>, %arg1: !dataflow.stream<f32, 160000>) {
    affine.for %arg2 = 0 to 400 {
      affine.for %arg3 = 0 to 400 {
        %0 = affine.load %arg0[%arg2, %arg3] : memref<400x400xf32>
        dataflow.stream_write %arg1, %0 : <f32, 160000>, f32
      } {loop_directive = #dataflow.pipeline_ii<pipeline=true, targetII=1, dataflow=false, flatten=false>}
    }
    return
  }
  func.func @node4(%arg0: memref<400x400xf32>, %arg1: memref<400xf32>, %arg2: !dataflow.stream<f32, 400>, %arg3: f32) {
    ...
    affine.for %arg4 = 0 to 400 {
      affine.for %arg5 = 0 to 400 {
        %0 = affine.load %arg0[%arg5, %arg4] : memref<400x400xf32>
        %1 = affine.load %arg1[%arg4] : memref<400xf32>
        affine.if #set(%arg4) {
          affine.store %arg3, %alloc[%arg5] : memref<400xf32>
        }
  ...
  func.func @forward(%arg0: memref<400x400xf32>, %arg1: memref<400x400xf32>, %arg2: memref<400xf32>, %arg3: memref<400xf32>, %arg4: memref<400xf32>, %arg5: memref<400xf32>) {
    ...
    %1 = dataflow.stream {depth = 160000 : i32} : <f32, 160000>
    %2 = dataflow.stream {depth = 400 : i32} : <f32, 400>
    call @node4(%arg0, %arg2, %2, %cst) : (memref<400x400xf32>, memref<400xf32>, !dataflow.stream<f32, 400>, f32) -> ()
    call @node3(%arg1, %1) : (memref<400x400xf32>, !dataflow.stream<f32, 160000>) -> ()
    call @node2(%1, %arg3, %0, %cst) : (!dataflow.stream<f32, 160000>, memref<400xf32>, !dataflow.stream<f32, 400>, f32) -> ()
    call @node1(%2, %arg4) : (!dataflow.stream<f32, 400>, memref<400xf32>) -> ()
