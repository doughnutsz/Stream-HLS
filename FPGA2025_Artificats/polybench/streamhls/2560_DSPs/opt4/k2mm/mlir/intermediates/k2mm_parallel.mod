...
option gurobi_options 'opttol=1e-8 lim:time=60 tech:logfile=k2mm_parallel.log';
param b0_0 := 1;
param b2_0 := 1;
param b10000_0 := 1;
param b1_0 := 1;
...
subject to c_uf0_0:
	u0_0 * x0_0 == 190;
var x0_1 >= 16, <= 210, integer;
var u0_1 >= 1, <= 210, integer;
subject to c_uf0_1:
	u0_1 * x0_1 == 210;
...
subject to c_uf2_0:
	u2_0 * x2_0 == 220;
var x2_1 >= 16, <= 180, integer;
var u2_1 >= 1, <= 180, integer;
subject to c_uf2_1:
	u2_1 * x2_1 == 180;
var DSP_2, integer;
subject to c_DSP2:
...
var x3_0 >= 16, <= 220, integer;
var u3_0 >= 1, <= 220, integer;
subject to c_uf3_0:
	u3_0 * x3_0 == 220;
...
var ep1_2, integer;
subject to cep1_2:
	ep1_2 ==  + ((0 + (x2_1 - 1) * 1 * 1 + (x2_0 - 1) * 1 * 1 * x2_1)) * 1 * b2_0 - ((0 + (x2_1 - 1) * 1 * 1 + (x2_0 - 1) * 1 * 1 * x2_1)) * 1 * b2_0;
# inputs last read/write dependencies
var lt1_2, integer;
subject to clt1_2:
