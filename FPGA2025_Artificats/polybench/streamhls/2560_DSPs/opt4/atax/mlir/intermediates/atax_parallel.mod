...
param b1_0 := 1;
param b3_0 := 1;
var x0_0 >= 16, <= 410, integer;
var u0_0 >= 1, <= 410, integer;
subject to c_uf0_0:
	u0_0 * x0_0 == 410;
var x0_1 >= 16, <= 390, integer;
var u0_1 >= 1, <= 390, integer;
subject to c_uf0_1:
	u0_1 * x0_1 == 390;
var DSP_0, integer;
subject to c_DSP0:
...
subject to c_uf1_0:
	u1_0 * x1_0 == 390;
var x1_1 >= 16, <= 410, integer;
var u1_1 >= 1, <= 410, integer;
subject to c_uf1_1:
	u1_1 * x1_1 == 410;
var DSP_1, integer;
subject to c_DSP1:
...
subject to cep10000_0:
	ep10000_0 ==  + ((0 + (x0_1 - 1) * 1 * 1 + (x0_0 - 1) * 1 * 1 * x0_1)) * 1 * b0_0 - (0) * 1 * b0_0;
# inputs last read/write dependencies
...
var fw0, integer;
subject to cfw0:
	fw0 == st0 + ((0 + 0 * 1 * 1 + (x0_0 - 1) * 1 * 1 * x0_1)) * 1 * b0_0;
# node: 1 info
# start time
var st1, integer;
subject to cst_st1:
...
subject to cst_rlr0_1:
	rlr0_1 == st1 + ((0 + 0 * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 1 * b1_0;
var rlr2_1, integer;
subject to cst_rlr2_1:
	rlr2_1 == st1 + ((0 + (x1_1 - 1) * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 1 * b1_0;
# epilogues
var ep0_1, integer;
subject to cep0_1:
	ep0_1 ==  + ((0 + (x1_1 - 1) * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 1 * b1_0 - ((0 + 0 * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 1 * b1_0;
var ep2_1, integer;
subject to cep2_1:
	ep2_1 ==  + ((0 + (x1_1 - 1) * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 1 * b1_0 - ((0 + (x1_1 - 1) * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 1 * b1_0;
# inputs last read/write dependencies
var lt0_1, integer;
subject to clt0_1:
...
var fw1, integer;
subject to cfw1:
	fw1 == st1 + ((0 + 0 * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 1 * b1_0;
# node: 3 info
# start time
var st3, integer;
subject to cst_st3:
