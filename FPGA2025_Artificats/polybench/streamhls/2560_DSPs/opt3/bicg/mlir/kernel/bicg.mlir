      ...
      affine.for %arg5 = 0 to 26 {
        affine.for %arg6 = 0 to 10 {
          affine.for %arg7 = 0 to 15 {
            %0 = affine.load %arg0[%arg6 + %arg4 * 10, %arg7 + %arg5 * 15] : memref<410x390xf32, #map3>
            %1 = affine.load %arg1[%arg7 + %arg5 * 15] : memref<390xf32, #map2>
      ...
      affine.for %arg5 = 0 to 41 {
        affine.for %arg6 = 0 to 15 {
          affine.for %arg7 = 0 to 10 {
            %0 = affine.load %arg0[%arg7 + %arg5 * 10] : memref<410xf32, #map>
            %1 = affine.load %arg1[%arg7 + %arg5 * 10, %arg6 + %arg4 * 15] : memref<410x390xf32, #map3>
            affine.if #set2(%arg7, %arg5) {
              affine.store %arg3, %alloc[%arg6 + %arg4 * 15] : memref<390xf32, #map2>
            }
            %2 = affine.load %alloc[%arg6 + %arg4 * 15] : memref<390xf32, #map2>
            %3 = arith.mulf %0, %1 : f32
            %4 = arith.addf %2, %3 : f32
            affine.store %4, %alloc[%arg6 + %arg4 * 15] : memref<390xf32, #map2>
            affine.if #set3(%arg7, %arg5) {
              %5 = affine.load %alloc[%arg6 + %arg4 * 15] : memref<390xf32, #map2>
