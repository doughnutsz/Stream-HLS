...
#map3 = affine_map<(d0, d1) -> (d0 mod 4, d1 mod 10, d0 floordiv 4, d1 floordiv 10)>
...
module attributes {torch.debug_module_name = "gemm"} {
      ...
      affine.for %arg3 = 0 to 20 {
        affine.for %arg4 = 0 to 4 {
          affine.for %arg5 = 0 to 11 {
            %0 = dataflow.aofs_read %arg0[%arg4, %arg5] {map = #map1} : (tensor<4x11x!dataflow.stream<f32, 1000>>) -> f32
            affine.store %0, %arg1[%arg4 + %arg2 * 4, %arg5 + %arg3 * 11] : memref<200x220xf32, #map>
          }
        }
      ...
      affine.for %arg6 = 0 to 20 {
        affine.for %arg7 = 0 to 4 {
          affine.for %arg8 = 0 to 11 {
            %0 = dataflow.aofs_read %arg0[%arg7, %arg8] {map = #map1} : (tensor<4x11x!dataflow.stream<f32, 1000>>) -> f32
            %1 = affine.load %arg1[%arg7 + %arg5 * 4, %arg8 + %arg6 * 11] : memref<200x220xf32, #map>
            %2 = arith.truncf %arg3 : f64 to f32
            %3 = arith.mulf %1, %2 : f32
            %4 = arith.mulf %0, %arg4 : f32
            %5 = arith.addf %4, %3 : f32
            dataflow.aofs_write %arg2[%arg7, %arg8], %5 {map = #map1} : tensor<4x11x!dataflow.stream<f32, 1000>>, f32
          }
        }
      } {loop_directive = #dataflow.pipeline_ii<pipeline=true, targetII=1, dataflow=false, flatten=false>}
    }
  ...
  func.func @node2(%arg0: memref<240x220xf32, #map2>, %arg1: memref<200x240xf32, #map3>, %arg2: tensor<4x11x!dataflow.stream<f32, 1000>>, %arg3: f32) {
          ...
          affine.for %arg7 = 0 to 4 {
            affine.for %arg8 = 0 to 11 {
              affine.for %arg9 = 0 to 10 {
                %0 = affine.load %arg1[%arg7 + %arg4 * 4, %arg9 + %arg6 * 10] : memref<200x240xf32, #map3>
                %1 = affine.load %arg0[%arg9 + %arg6 * 10, %arg8 + %arg5 * 11] : memref<240x220xf32, #map2>
                affine.if #set(%arg9, %arg6) {
                  affine.store %arg3, %alloc[%arg7 + %arg4 * 4, %arg8 + %arg5 * 11] : memref<200x220xf32, #map>
                }
                %2 = affine.load %alloc[%arg7 + %arg4 * 4, %arg8 + %arg5 * 11] : memref<200x220xf32, #map>
                %3 = arith.mulf %0, %1 : f32
                %4 = arith.addf %2, %3 : f32
                affine.store %4, %alloc[%arg7 + %arg4 * 4, %arg8 + %arg5 * 11] : memref<200x220xf32, #map>
                affine.if #set1(%arg9, %arg6) {
                  %5 = affine.load %alloc[%arg7 + %arg4 * 4, %arg8 + %arg5 * 11] : memref<200x220xf32, #map>
                  dataflow.aofs_write %arg2[%arg7, %arg8], %5 {map = #map1} : tensor<4x11x!dataflow.stream<f32, 1000>>, f32
                }
              }
            }
  ...
  func.func @forward(%arg0: memref<200x240xf32, #map3>, %arg1: memref<240x220xf32, #map2>, %arg2: memref<200x220xf32, #map>, %arg3: memref<200x220xf32, #map>) {
    ...
    call @node2(%arg1, %arg0, %1, %cst_1) : (memref<240x220xf32, #map2>, memref<200x240xf32, #map3>, tensor<4x11x!dataflow.stream<f32, 1000>>, f32) -> ()
