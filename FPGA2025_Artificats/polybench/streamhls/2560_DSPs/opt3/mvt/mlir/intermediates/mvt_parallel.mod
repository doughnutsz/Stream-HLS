...
option gurobi_options 'opttol=1e-8 lim:time=60 tech:logfile=mvt_parallel.log';
param b0_0 := 1;
param b2_0 := 1;
param b10000_0 := 1;
param b4_0 := 1;
...
subject to cst_rlr2_3:
	rlr2_3 == st3 + ((0 + (x3_1 - 1) * 1 * 1 + (x3_0 - 1) * 1 * 1 * x3_1)) * 4 * b3_0;
# epilogues
var ep2_3, integer;
subject to cep2_3:
	ep2_3 ==  + ((0 + (x3_1 - 1) * 1 * 1 + (x3_0 - 1) * 1 * 1 * x3_1)) * 4 * b3_0 - ((0 + (x3_1 - 1) * 1 * 1 + (x3_0 - 1) * 1 * 1 * x3_1)) * 4 * b3_0;
# inputs last read/write dependencies
var lt2_3, integer;
subject to clt2_3:
...
var fw3, integer;
subject to cfw3:
	fw3 == st3 + ((0 + (x3_1 - 1) * 1 * 1 + 0 * 1 * 1 * x3_1)) * 4 * b3_0;
# node: 4 info
# start time
var st4, integer;
subject to cst_st4:
