...
option gurobi_options 'opttol=1e-8 lim:time=60 tech:logfile=atax_parallel.log';
param b0_0 := 1;
param b2_0 := 1;
param b10000_0 := 1;
param b1_0 := 1;
...
subject to cep10000_0:
	ep10000_0 ==  + ((0 + (x0_1 - 1) * 1 * 1 + (x0_0 - 1) * 1 * 1 * x0_1)) * 4 * b0_0 - (0) * 4 * b0_0;
# inputs last read/write dependencies
...
var fw0, integer;
subject to cfw0:
	fw0 == st0 + ((0 + (x0_1 - 1) * 1 * 1 + 0 * 1 * 1 * x0_1)) * 4 * b0_0;
# node: 1 info
# start time
var st1, integer;
subject to cst_st1:
	st1 == max( + fw0*b0_0*b1_0,  + lw2*b2_0*b1_0);
# relative last reads
var rlr0_1, integer;
subject to cst_rlr0_1:
	rlr0_1 == st1 + ((0 + (x1_1 - 1) * 1 * 1 + 0 * 1 * 1 * x1_1)) * 4 * b1_0;
var rlr2_1, integer;
subject to cst_rlr2_1:
	rlr2_1 == st1 + ((0 + (x1_1 - 1) * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 4 * b1_0;
# epilogues
var ep0_1, integer;
subject to cep0_1:
	ep0_1 ==  + ((0 + (x1_1 - 1) * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 4 * b1_0 - ((0 + (x1_1 - 1) * 1 * 1 + 0 * 1 * 1 * x1_1)) * 4 * b1_0;
var ep2_1, integer;
subject to cep2_1:
	ep2_1 ==  + ((0 + (x1_1 - 1) * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 4 * b1_0 - ((0 + (x1_1 - 1) * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 4 * b1_0;
# inputs last read/write dependencies
var lt0_1, integer;
subject to clt0_1:
...
var fw1, integer;
subject to cfw1:
	fw1 == st1 + ((0 + (x1_1 - 1) * 1 * 1 + 0 * 1 * 1 * x1_1)) * 4 * b1_0;
# node: 3 info
# start time
var st3, integer;
subject to cst_st3:
