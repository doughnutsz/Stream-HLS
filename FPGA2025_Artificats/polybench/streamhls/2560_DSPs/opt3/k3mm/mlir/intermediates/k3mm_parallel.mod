...
subject to c_uf2_0:
	u2_0 * x2_0 == 190;
var x2_1 >= 16, <= 210, integer;
var u2_1 >= 1, <= 210, integer;
subject to c_uf2_1:
	u2_1 * x2_1 == 210;
var x2_2 >= 16, <= 220, integer;
var u2_2 >= 1, <= 220, integer;
subject to c_uf2_2:
	u2_2 * x2_2 == 220;
var DSP_2, integer;
subject to c_DSP2:
...
subject to c_uf3_0:
	u3_0 * x3_0 == 180;
var x3_1 >= 16, <= 210, integer;
var u3_1 >= 1, <= 210, integer;
subject to c_uf3_1:
	u3_1 * x3_1 == 210;
var DSP_3, integer;
subject to c_DSP3:
...
subject to cep10000_2:
	ep10000_2 ==  + ((0 + (x2_2 - 1) * 1 * 1 + (x2_1 - 1) * 1 * 1 * x2_2 + (x2_0 - 1) * 1 * 1 * x2_2 * x2_1)) * 4 * b2_0 - (0) * 4 * b2_0;
...
subject to cst_rlr2_1:
	rlr2_1 == st1 + ((0 + (x1_2 - 1) * 1 * 1 + (x1_1 - 1) * 1 * 1 * x1_2 + 0 * 1 * 1 * x1_2 * x1_1)) * 4 * b1_0;
# epilogues
var ep0_1, integer;
subject to cep0_1:
...
var ep2_1, integer;
subject to cep2_1:
	ep2_1 ==  + ((0 + (x1_2 - 1) * 1 * 1 + (x1_1 - 1) * 1 * 1 * x1_2 + (x1_0 - 1) * 1 * 1 * x1_2 * x1_1)) * 4 * b1_0 - ((0 + (x1_2 - 1) * 1 * 1 + (x1_1 - 1) * 1 * 1 * x1_2 + 0 * 1 * 1 * x1_2 * x1_1)) * 4 * b1_0;
# inputs last read/write dependencies
var lt0_1, integer;
subject to clt0_1:
