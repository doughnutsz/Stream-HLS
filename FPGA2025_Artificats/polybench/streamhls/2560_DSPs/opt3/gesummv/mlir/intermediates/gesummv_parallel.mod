...
option gurobi_options 'opttol=1e-8 lim:time=60 tech:logfile=gesummv_parallel.log';
param b0_0 := 1;
param b2_0 := 1;
param b10000_0 := 1;
param b1_0 := 1;
param b3_0 := 1;
var x0_0 >= 16, <= 250, integer;
var u0_0 >= 1, <= 250, integer;
subject to c_uf0_0:
	u0_0 * x0_0 == 250;
var x0_1 >= 16, <= 250, integer;
var u0_1 >= 1, <= 250, integer;
subject to c_uf0_1:
	u0_1 * x0_1 == 250;
var DSP_0, integer;
subject to c_DSP0:
	DSP_0 == u0_0 * u0_1;
var x2_0 >= 16, <= 250, integer;
var u2_0 >= 1, <= 250, integer;
subject to c_uf2_0:
	u2_0 * x2_0 == 250;
var x2_1 >= 16, <= 250, integer;
var u2_1 >= 1, <= 250, integer;
subject to c_uf2_1:
	u2_1 * x2_1 == 250;
var DSP_2, integer;
subject to c_DSP2:
	DSP_2 == u2_0 * u2_1;
var x1_0 >= 16, <= 250, integer;
var u1_0 >= 1, <= 250, integer;
subject to c_uf1_0:
	u1_0 * x1_0 == 250;
var DSP_1, integer;
subject to c_DSP1:
	DSP_1 == 0;
var x3_0 >= 16, <= 250, integer;
var u3_0 >= 1, <= 250, integer;
subject to c_uf3_0:
	u3_0 * x3_0 == 250;
var DSP_3, integer;
subject to c_DSP3:
...
subject to cst_rlr10000_2:
	rlr10000_2 == st2 + (0) * 4 * b2_0;
# epilogues
var ep10000_2, integer;
subject to cep10000_2:
	ep10000_2 ==  + ((0 + (x2_1 - 1) * 1 * 1 + (x2_0 - 1) * 1 * 1 * x2_1)) * 4 * b2_0 - (0) * 4 * b2_0;
...
var fw2, integer;
subject to cfw2:
	fw2 == st2 + ((0 + (x2_1 - 1) * 1 * 1 + 0 * 1 * 1 * x2_1)) * 4 * b2_0;
# node: 0 info
# start time
var st0, integer;
subject to cst_st0:
