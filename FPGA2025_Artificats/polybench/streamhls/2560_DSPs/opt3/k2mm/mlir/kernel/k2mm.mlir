...
module attributes {torch.debug_module_name = "k2mm"} {
            ...
            affine.for %arg8 = 0 to 11 {
              affine.for %arg9 = 0 to 10 {
                affine.if #set(%arg8, %arg5) {
                  %5 = dataflow.aofs_read %arg0[%arg7, %arg9] {map = #map1} : (tensor<2x10x!dataflow.stream<f32, 1710>>) -> f32
                  affine.store %5, %alloc_0[%arg7 + %arg4 * 2, %arg9 + %arg6 * 10] : memref<180x190xf32, #map3>
                }
                %0 = affine.load %alloc_0[%arg7 + %arg4 * 2, %arg9 + %arg6 * 10] : memref<180x190xf32, #map3>
                %1 = affine.load %arg1[%arg9 + %arg6 * 10, %arg8 + %arg5 * 11] : memref<190x220xf32, #map2>
                affine.if #set1(%arg9, %arg6) {
                  affine.store %arg3, %alloc[%arg7 + %arg4 * 2, %arg8 + %arg5 * 11] : memref<180x220xf32, #map>
                }
                %2 = affine.load %alloc[%arg7 + %arg4 * 2, %arg8 + %arg5 * 11] : memref<180x220xf32, #map>
                %3 = arith.mulf %0, %1 : f32
                %4 = arith.addf %2, %3 : f32
                affine.store %4, %alloc[%arg7 + %arg4 * 2, %arg8 + %arg5 * 11] : memref<180x220xf32, #map>
                affine.if #set2(%arg9, %arg6) {
                  %5 = affine.load %alloc[%arg7 + %arg4 * 2, %arg8 + %arg5 * 11] : memref<180x220xf32, #map>
                  dataflow.aofs_write %arg2[%arg7, %arg8], %5 {map = #map1} : tensor<2x11x!dataflow.stream<f32, 1800>>, f32
                }
              }
            }
  ...
  func.func @node3(%arg0: memref<210x190xf32, #map4>, %arg1: memref<180x210xf32, #map3>, %arg2: tensor<2x10x!dataflow.stream<f32, 1710>>, %arg3: f32) {
        ...
        affine.for %arg6 = 0 to 21 {
          affine.for %arg7 = 0 to 2 {
            affine.for %arg8 = 0 to 10 {
              affine.for %arg9 = 0 to 10 {
                %0 = affine.load %arg1[%arg7 + %arg4 * 2, %arg9 + %arg6 * 10] : memref<180x210xf32, #map3>
                %1 = affine.load %arg0[%arg9 + %arg6 * 10, %arg8 + %arg5 * 10] : memref<210x190xf32, #map4>
                affine.if #set1(%arg9, %arg6) {
                  affine.store %arg3, %alloc[%arg7 + %arg4 * 2, %arg8 + %arg5 * 10] : memref<180x190xf32, #map3>
                }
                %2 = affine.load %alloc[%arg7 + %arg4 * 2, %arg8 + %arg5 * 10] : memref<180x190xf32, #map3>
                %3 = arith.mulf %0, %1 : f32
                %4 = arith.addf %2, %3 : f32
                affine.store %4, %alloc[%arg7 + %arg4 * 2, %arg8 + %arg5 * 10] : memref<180x190xf32, #map3>
                affine.if #set3(%arg9, %arg6) {
                  %5 = affine.load %alloc[%arg7 + %arg4 * 2, %arg8 + %arg5 * 10] : memref<180x190xf32, #map3>
                  dataflow.aofs_write %arg2[%arg7, %arg8], %5 {map = #map1} : tensor<2x10x!dataflow.stream<f32, 1710>>, f32
                }
              }
            }
          }
  ...
  func.func @forward(%arg0: memref<180x210xf32, #map3>, %arg1: memref<210x190xf32, #map4>, %arg2: memref<190x220xf32, #map2>, %arg3: memref<180x220xf32, #map>, %arg4: memref<180x220xf32, #map>) {
    ...
    call @node3(%arg1, %arg0, %2, %cst_1) : (memref<210x190xf32, #map4>, memref<180x210xf32, #map3>, tensor<2x10x!dataflow.stream<f32, 1710>>, f32) -> ()
