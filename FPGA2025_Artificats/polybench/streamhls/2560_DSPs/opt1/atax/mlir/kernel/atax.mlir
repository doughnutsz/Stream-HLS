...
module attributes {torch.debug_module_name = "atax"} {
  ...
  func.func @node1(%arg0: memref<410x390xf32>, %arg1: !dataflow.stream<f32, 390>, %arg2: !dataflow.stream<f32, 410>, %arg3: f32) {
    ...
    affine.for %arg4 = 0 to 410 {
      affine.for %arg5 = 0 to 390 {
        ...
        affine.if #set(%arg4) {
          ...
          affine.store %5, %alloc_0[%arg5] : memref<390xf32>
        }
        %1 = affine.load %alloc_0[%arg5] : memref<390xf32>
        affine.if #set(%arg5) {
  ...
  func.func @node2(%arg0: memref<390x410xf32>, %arg1: memref<410x390xf32>) {
    affine.for %arg2 = 0 to 390 {
      affine.for %arg3 = 0 to 410 {
        %0 = affine.load %arg0[%arg2, %arg3] : memref<390x410xf32>
        affine.store %0, %arg1[%arg3, %arg2] : memref<410x390xf32>
      } {loop_directive = #dataflow.pipeline_ii<pipeline=true, targetII=1, dataflow=false, flatten=false>}
    }
    return
  }
  ...
  func.func @forward(%arg0: memref<390x410xf32>, %arg1: memref<410xf32>, %arg2: memref<410xf32>) {
    ...
    %alloc = memref.alloc() {alignment = 64 : i64} : memref<410x390xf32>
    %1 = dataflow.stream {depth = 390 : i32} : <f32, 390>
    call @node3(%arg0, %arg1, %1, %cst) : (memref<390x410xf32>, memref<410xf32>, !dataflow.stream<f32, 390>, f32) -> ()
    call @node2(%arg0, %alloc) : (memref<390x410xf32>, memref<410x390xf32>) -> ()
    call @node1(%alloc, %1, %0, %cst) : (memref<410x390xf32>, !dataflow.stream<f32, 390>, !dataflow.stream<f32, 410>, f32) -> ()
