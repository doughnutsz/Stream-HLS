          ...
          affine.for %arg7 = 0 to 10 {
            affine.for %arg8 = 0 to 4 {
              affine.for %arg9 = 0 to 11 {
                %0 = affine.load %arg0[%arg8 + %arg5 * 4, %arg7 + %arg4 * 10] : memref<200x240xf32, #map2>
                %1 = affine.load %arg1[%arg7 + %arg4 * 10, %arg9 + %arg6 * 11] : memref<240x220xf32, #map3>
                affine.if #set(%arg7, %arg4) {
                  affine.store %arg3, %alloc[%arg8 + %arg5 * 4, %arg9 + %arg6 * 11] : memref<200x220xf32, #map>
                }
                %2 = affine.load %alloc[%arg8 + %arg5 * 4, %arg9 + %arg6 * 11] : memref<200x220xf32, #map>
                %3 = arith.mulf %0, %1 : f32
                %4 = arith.addf %2, %3 : f32
                affine.store %4, %alloc[%arg8 + %arg5 * 4, %arg9 + %arg6 * 11] : memref<200x220xf32, #map>
                affine.if #set1(%arg7, %arg4) {
                  %5 = affine.load %alloc[%arg8 + %arg5 * 4, %arg9 + %arg6 * 11] : memref<200x220xf32, #map>
                  dataflow.aofs_write %arg2[%arg8, %arg9], %5 {map = #map1} : tensor<4x11x!dataflow.stream<f32, 1000>>, f32
                }
              }
            }
          }
