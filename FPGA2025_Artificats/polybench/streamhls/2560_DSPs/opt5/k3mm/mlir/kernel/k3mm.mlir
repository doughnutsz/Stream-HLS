...
module attributes {torch.debug_module_name = "k3mm"} {
  ...
  func.func @node3(%arg0: memref<180x200xf32, #map>, %arg1: memref<200x190xf32, #map6>, %arg2: tensor<3x5x!dataflow.stream<f32, 2280>>, %arg3: f32) {
      ...
      affine.for %arg5 = 0 to 20 {
        affine.for %arg6 = 0 to 60 {
          affine.for %arg7 = 0 to 5 {
            affine.for %arg8 = 0 to 10 {
              affine.for %arg9 = 0 to 3 {
                %0 = affine.load %arg0[%arg9 + %arg6 * 3, %arg8 + %arg5 * 10] : memref<180x200xf32, #map>
                %1 = affine.load %arg1[%arg8 + %arg5 * 10, %arg7 + %arg4 * 5] : memref<200x190xf32, #map6>
                affine.if #set(%arg8, %arg5) {
  ...
  func.func @forward(%arg0: memref<180x200xf32, #map>, %arg1: memref<200x190xf32, #map6>, %arg2: memref<190x220xf32, #map4>, %arg3: memref<220x210xf32, #map5>, %arg4: memref<180x210xf32, #map>) {
    ...
    call @node3(%arg0, %arg1, %2, %cst) : (memref<180x200xf32, #map>, memref<200x190xf32, #map6>, tensor<3x5x!dataflow.stream<f32, 2280>>, f32) -> ()
