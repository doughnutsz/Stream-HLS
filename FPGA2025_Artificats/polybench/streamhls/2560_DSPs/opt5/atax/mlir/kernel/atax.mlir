...
module attributes {torch.debug_module_name = "atax"} {
  ...
  func.func @node1(%arg0: tensor<15x!dataflow.stream<f32, 26>>, %arg1: tensor<10x15x!dataflow.stream<f32, 1066>>, %arg2: tensor<10x!dataflow.stream<f32, 41>>, %arg3: f32) {
      ...
      affine.for %arg5 = 0 to 41 {
        affine.for %arg6 = 0 to 15 {
          affine.for %arg7 = 0 to 10 {
            %0 = dataflow.aofs_read %arg1[%arg7, %arg6] {map = #map3} : (tensor<10x15x!dataflow.stream<f32, 1066>>) -> f32
            affine.if #set(%arg7, %arg5) {
              %5 = dataflow.aofs_read %arg0[%arg6] {map = #map1} : (tensor<15x!dataflow.stream<f32, 26>>) -> f32
  ...
  func.func @forward(%arg0: memref<390x410xf32, #map4>, %arg1: memref<410xf32, #map>, %arg2: memref<410xf32, #map>) {
    ...
    call @node1(%2, %1, %0, %cst) : (tensor<15x!dataflow.stream<f32, 26>>, tensor<10x15x!dataflow.stream<f32, 1066>>, tensor<10x!dataflow.stream<f32, 41>>, f32) -> ()
