...
void node1(
  ...
  loop4: for (int v12 = 0; v12 < 50; v12++) {
    loop5: for (int v13 = 0; v13 < 220; v13++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      loop6: for (int v14 = 0; v14 < 4; v14++) {
        loop7: for (int v15 = 0; v15 < 1; v15++) {
          float v16 = v7[v14][v15].read();
          float v17 = v8[(v14 + (v12 * 4))][(v13 + v15)];
          float v18 = v10;
          float v19 = v17 * v18;
          float v20 = v16 * v11;
          float v21 = v20 + v19;
...
void node2(
  ...
  loop8: for (int v27 = 0; v27 < 30; v27++) {
    loop9: for (int v28 = 0; v28 < 50; v28++) {
      loop10: for (int v29 = 0; v29 < 220; v29++) {
        #pragma HLS pipeline II=1
        #pragma HLS loop_flatten
        loop11: for (int v30 = 0; v30 < 8; v30++) {
          loop12: for (int v31 = 0; v31 < 4; v31++) {
            loop13: for (int v32 = 0; v32 < 1; v32++) {
              float v33 = v23[(v31 + (v28 * 4))][(v30 + (v27 * 8))];
              float v34 = v22[(v30 + (v27 * 8))][(v29 + v32)];
              if ((v30 + (v27 * 8)) == 0) {
                v26[(v31 + (v28 * 4))][(v29 + v32)] = v25;
              }
              float v35 = v26[(v31 + (v28 * 4))][(v29 + v32)];
              float v36 = v33 * v34;
              float v37 = v35 + v36;
              v26[(v31 + (v28 * 4))][(v29 + v32)] = v37;
              if (((v30 + (v27 * 8)) - 239) == 0) {
                float v38 = v26[(v31 + (v28 * 4))][(v29 + v32)];
...
void forward(
  ...
  #pragma HLS array_partition variable=v40 cyclic dim=1 factor=8
  ...
  hls::stream<float> v43[4][1];
	#pragma HLS STREAM variable=v43 depth=11000
  hls::stream<float> v44[4][1];
	#pragma HLS STREAM variable=v44 depth=11000
