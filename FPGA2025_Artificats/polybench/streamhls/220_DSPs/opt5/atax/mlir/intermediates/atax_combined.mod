...
option gurobi_options 'opttol=1e-8 lim:time=60 tech:logfile=atax_combined.log';
...
subject to c_DSP0:
	DSP_0 == u0_0 * u0_1 * 5;
var x2_0 >= 16, <= 390, integer;
var u2_0 >= 1, <= 390, integer;
subject to c_uf2_0:
	u2_0 * x2_0 == 390;
var x2_1 >= 16, <= 410, integer;
...
subject to c_DSP2:
	DSP_2 == u2_0 * u2_1 * 0;
var x1_0 >= 16, <= 410, integer;
var u1_0 >= 1, <= 410, integer;
subject to c_uf1_0:
	u1_0 * x1_0 == 410;
var x1_1 >= 16, <= 390, integer;
var u1_1 >= 1, <= 390, integer;
subject to c_uf1_1:
	u1_1 * x1_1 == 390;
var DSP_1, integer;
subject to c_DSP1:
...
subject to c_DSP3:
	DSP_3 == u3_0 * 0;
subject to c_u1_1_u0_0:
	u1_1 == u0_0;
subject to c_u1_0_u2_1:
	u1_0 == u2_1;
subject to c_u1_1_u2_0:
	u1_1 == u2_0;
...
var st1, integer;
subject to cst_st1:
	st1 == max( + fw0*b0_0*b1_0 + fw0*b0_1*b1_0 + fw0*b0_0*b1_1 + fw0*b0_1*b1_1,  + lw2*b2_0*b1_0 + fw2*b2_1*b1_0 + fw2*b2_0*b1_1 + lw2*b2_1*b1_1);
# relative last reads
var rlr0_1, integer;
subject to cst_rlr0_1:
	rlr0_1 == st1 + ((0 + (x1_1 - 1) * 1 * 1 + 0 * 1 * 1 * x1_1)) * 4 * b1_0 + ((0 + 0 * 1 * 1 + (x1_1 - 1) * 1 * 1 * x1_0)) * 1 * b1_1;
var rlr2_1, integer;
subject to cst_rlr2_1:
	rlr2_1 == st1 + ((0 + (x1_1 - 1) * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 4 * b1_0 + ((0 + (x1_0 - 1) * 1 * 1 + (x1_1 - 1) * 1 * 1 * x1_0)) * 1 * b1_1;
# epilogues
var ep0_1, integer;
subject to cep0_1:
	ep0_1 ==  + ((0 + (x1_1 - 1) * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 4 * b1_0 - ((0 + (x1_1 - 1) * 1 * 1 + 0 * 1 * 1 * x1_1)) * 4 * b1_0 + ((0 + (x1_0 - 1) * 1 * 1 + (x1_1 - 1) * 1 * 1 * x1_0)) * 1 * b1_1 - ((0 + 0 * 1 * 1 + (x1_1 - 1) * 1 * 1 * x1_0)) * 1 * b1_1;
var ep2_1, integer;
subject to cep2_1:
	ep2_1 ==  + ((0 + (x1_1 - 1) * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 4 * b1_0 - ((0 + (x1_1 - 1) * 1 * 1 + (x1_0 - 1) * 1 * 1 * x1_1)) * 4 * b1_0 + ((0 + (x1_0 - 1) * 1 * 1 + (x1_1 - 1) * 1 * 1 * x1_0)) * 1 * b1_1 - ((0 + (x1_0 - 1) * 1 * 1 + (x1_1 - 1) * 1 * 1 * x1_0)) * 1 * b1_1;
# inputs last read/write dependencies
var lt0_1, integer;
subject to clt0_1:
...
var fw1, integer;
subject to cfw1:
	fw1 == st1 + ((0 + (x1_1 - 1) * 1 * 1 + 0 * 1 * 1 * x1_1)) * 4 * b1_0 + ((0 + 0 * 1 * 1 + (x1_1 - 1) * 1 * 1 * x1_0)) * 1 * b1_1;
# node: 3 info
# start time
var st3, integer;
subject to cst_st3:
	st3 == ( + fw1*b1_0*b3_0 + fw1*b1_1*b3_0);
# relative last reads
var rlr1_3, integer;
