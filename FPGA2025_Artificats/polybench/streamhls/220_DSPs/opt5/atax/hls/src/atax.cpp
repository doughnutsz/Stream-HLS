...
void node1(
  ...
  loop2: for (int v11 = 0; v11 < 195; v11++) {
    loop3: for (int v12 = 0; v12 < 41; v12++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      loop4: for (int v13 = 0; v13 < 2; v13++) {
...
void node2(
  ...
  loop6: for (int v24 = 0; v24 < 195; v24++) {
    loop7: for (int v25 = 0; v25 < 41; v25++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      loop8: for (int v26 = 0; v26 < 2; v26++) {
        loop9: for (int v27 = 0; v27 < 10; v27++) {
          float v28 = v22[(v26 + (v24 * 2))][(v27 + (v25 * 10))];
...
void node3(
  ...
  loop10: for (int v34 = 0; v34 < 41; v34++) {
    loop11: for (int v35 = 0; v35 < 195; v35++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      loop12: for (int v36 = 0; v36 < 10; v36++) {
        loop13: for (int v37 = 0; v37 < 2; v37++) {
          float v38 = v29[(v37 + (v35 * 2))][(v36 + (v34 * 10))];
          float v39 = v30[(v36 + (v34 * 10))];
          if ((v36 + (v34 * 10)) == 0) {
            v33[(v37 + (v35 * 2))] = v32;
          }
          float v40 = v33[(v37 + (v35 * 2))];
          float v41 = v38 * v39;
          float v42 = v40 + v41;
          v33[(v37 + (v35 * 2))] = v42;
          if (((v36 + (v34 * 10)) - 409) == 0) {
            float v43 = v33[(v37 + (v35 * 2))];
            v31[v37].write(v43);
          }
        }
      }
...
void forward(
  ...
  hls::stream<float> v48[10][2];
	#pragma HLS STREAM variable=v48 depth=7995
  hls::stream<float> v49[2];
	#pragma HLS STREAM variable=v49 depth=195
