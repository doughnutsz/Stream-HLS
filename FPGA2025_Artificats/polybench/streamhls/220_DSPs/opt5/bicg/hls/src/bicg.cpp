...
void node2(
  ...
  #pragma HLS array_partition variable=v10 cyclic dim=1 factor=2
  #pragma HLS array_partition variable=v10 cyclic dim=2 factor=10
  ...
  loop4: for (int v15 = 0; v15 < 39; v15++) {
    loop5: for (int v16 = 0; v16 < 205; v16++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      loop6: for (int v17 = 0; v17 < 10; v17++) {
        loop7: for (int v18 = 0; v18 < 2; v18++) {
          float v19 = v10[(v18 + (v16 * 2))][(v17 + (v15 * 10))];
...
void node3(
  ...
  float v29[390];
  #pragma HLS array_partition variable=v29 cyclic dim=1 factor=2

  loop8: for (int v30 = 0; v30 < 41; v30++) {
    loop9: for (int v31 = 0; v31 < 195; v31++) {
      #pragma HLS pipeline II=1
      #pragma HLS loop_flatten
      loop10: for (int v32 = 0; v32 < 10; v32++) {
        loop11: for (int v33 = 0; v33 < 2; v33++) {
          float v34 = v25[(v32 + (v30 * 10))];
          float v35 = v26[(v32 + (v30 * 10))][(v33 + (v31 * 2))];
          if ((v32 + (v30 * 10)) == 0) {
            v29[(v33 + (v31 * 2))] = v28;
          }
          float v36 = v29[(v33 + (v31 * 2))];
          float v37 = v34 * v35;
          float v38 = v36 + v37;
          v29[(v33 + (v31 * 2))] = v38;
          if (((v32 + (v30 * 10)) - 409) == 0) {
            float v39 = v29[(v33 + (v31 * 2))];
            v27[v33].write(v39);
          }
        }
      }
...
void forward(
  ...
  #pragma HLS array_partition variable=v43 cyclic dim=1 factor=10

  #pragma HLS array_partition variable=v44 cyclic dim=1 factor=2

  #pragma HLS array_partition variable=v45 cyclic dim=1 factor=2

  hls::stream<float> v46[2];
	#pragma HLS STREAM variable=v46 depth=205
  hls::stream<float> v47[2];
	#pragma HLS STREAM variable=v47 depth=195
