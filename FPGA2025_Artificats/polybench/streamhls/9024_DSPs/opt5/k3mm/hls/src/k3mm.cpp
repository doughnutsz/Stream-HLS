...
void node1(
  ...
  loop4: for (int v14 = 0; v14 < 19; v14++) {
          ...
          loop8: for (int v18 = 0; v18 < 10; v18++) {
            loop9: for (int v19 = 0; v19 < 6; v19++) {
              if ((v19 + (v16 * 6)) == 0) {
                ...
                v13[(v18 + (v15 * 10))][(v17 + (v14 * 10))] = v20;
              }
              float v21 = v13[(v18 + (v15 * 10))][(v17 + (v14 * 10))];
              if ((v18 + (v15 * 10)) == 0) {
                float v22 = v8[v17][v19].read();
                v12[(v17 + (v14 * 10))][(v19 + (v16 * 6))] = v22;
              }
              float v23 = v12[(v17 + (v14 * 10))][(v19 + (v16 * 6))];
              if ((v17 + (v14 * 10)) == 0) {
...
void node2(
  float v28[190][220],
  float v29[220][210],
  hls::stream<float> v30[10][6],
  float v31
) {
  #pragma HLS array_partition variable=v28 cyclic dim=1 factor=10
  #pragma HLS array_partition variable=v28 cyclic dim=2 factor=11

  #pragma HLS array_partition variable=v29 cyclic dim=1 factor=11
  #pragma HLS array_partition variable=v29 cyclic dim=2 factor=6
        ...
        loop13: for (int v36 = 0; v36 < 10; v36++) {
          loop14: for (int v37 = 0; v37 < 11; v37++) {
            loop15: for (int v38 = 0; v38 < 6; v38++) {
              float v39 = v28[(v36 + (v33 * 10))][(v37 + (v34 * 11))];
              float v40 = v29[(v37 + (v34 * 11))][(v38 + (v35 * 6))];
              if ((v37 + (v34 * 11)) == 0) {
                v32[(v36 + (v33 * 10))][(v38 + (v35 * 6))] = v31;
              }
              float v41 = v32[(v36 + (v33 * 10))][(v38 + (v35 * 6))];
              float v42 = v39 * v40;
              float v43 = v41 + v42;
              v32[(v36 + (v33 * 10))][(v38 + (v35 * 6))] = v43;
              if (((v37 + (v34 * 11)) - 219) == 0) {
                float v44 = v32[(v36 + (v33 * 10))][(v38 + (v35 * 6))];
...
void node3(
  ...
  loop16: for (int v50 = 0; v50 < 19; v50++) {
        ...
        loop19: for (int v53 = 0; v53 < 10; v53++) {
          loop20: for (int v54 = 0; v54 < 5; v54++) {
            loop21: for (int v55 = 0; v55 < 10; v55++) {
              ...
              float v57 = v46[(v54 + (v51 * 5))][(v53 + (v50 * 10))];
              if ((v54 + (v51 * 5)) == 0) {
                v49[(v55 + (v52 * 10))][(v53 + (v50 * 10))] = v48;
              }
              float v58 = v49[(v55 + (v52 * 10))][(v53 + (v50 * 10))];
              float v59 = v56 * v57;
              float v60 = v58 + v59;
              v49[(v55 + (v52 * 10))][(v53 + (v50 * 10))] = v60;
              if (((v54 + (v51 * 5)) - 199) == 0) {
                float v61 = v49[(v55 + (v52 * 10))][(v53 + (v50 * 10))];
...
void forward(
  ...
  hls::stream<float> v68[10][6];
	#pragma HLS STREAM variable=v68 depth=665
