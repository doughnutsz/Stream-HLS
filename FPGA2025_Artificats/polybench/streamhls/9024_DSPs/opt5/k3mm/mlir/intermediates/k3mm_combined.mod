...
option gurobi_options 'opttol=1e-8 lim:time=60 tech:logfile=k3mm_combined.log';
...
var st3, integer;
subject to cst_st3:
	st3 == ( + fw1*b1_0*b3_0 + fw1*b1_1*b3_0 + lw1*b1_2*b3_0 + fw1*b1_3*b3_0 + lw1*b1_4*b3_0 + lw1*b1_5*b3_0 + lw1*b1_0*b3_1 + lw1*b1_1*b3_1 + fw1*b1_2*b3_1 + lw1*b1_3*b3_1 + fw1*b1_4*b3_1 + fw1*b1_5*b3_1);
# relative last reads
var rlr1_3, integer;
subject to cst_rlr1_3:
	rlr1_3 == st3 + ((0 + (x3_1 - 1) * 1 * 1 + (x3_0 - 1) * 1 * 1 * x3_1)) * 1 * b3_0 + ((0 + (x3_0 - 1) * 1 * 1 + (x3_1 - 1) * 1 * 1 * x3_0)) * 1 * b3_1;
# epilogues
var ep1_3, integer;
subject to cep1_3:
	ep1_3 == 0;
