...
for topFunc in topFuncs:
  ...
  tb_path = f'{topFunc}/{topFunc}_tb.cpp'
  kernel_path = f'{topFunc}/{topFunc}.cpp'
  ...
  # )
  top_name = f'kernel'
  # search for #define in kernel_code
  defines = re.findall(r'#define .+\n', kernel_code)
  ...
  arguments_type = [re.sub(r'\[.+\]', '', arg) for arg in arguments_type_shape]
