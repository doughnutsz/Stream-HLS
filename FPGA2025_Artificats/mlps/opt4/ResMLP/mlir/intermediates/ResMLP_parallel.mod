...
subject to c_uf0_0:
	u0_0 * x0_0 == 8;
var x0_1 >= 16, <= 1024, integer;
var u0_1 >= 1, <= 1024, integer;
subject to c_uf0_1:
	u0_1 * x0_1 == 1024;
var x0_2 >= 16, <= 512, integer;
var u0_2 >= 1, <= 512, integer;
subject to c_uf0_2:
	u0_2 * x0_2 == 512;
var DSP_0, integer;
subject to c_DSP0:
...
subject to c_uf7_0:
	u7_0 * x7_0 == 8;
var x7_1 >= 16, <= 512, integer;
var u7_1 >= 1, <= 512, integer;
subject to c_uf7_1:
	u7_1 * x7_1 == 512;
var x7_2 >= 16, <= 256, integer;
var u7_2 >= 1, <= 256, integer;
subject to c_uf7_2:
	u7_2 * x7_2 == 256;
var DSP_7, integer;
subject to c_DSP7:
...
subject to c_DSP13:
	DSP_13 == 0;
var x1_0 >= 16, <= 1024, integer;
var u1_0 >= 1, <= 1024, integer;
subject to c_uf1_0:
	u1_0 * x1_0 == 1024;
var x1_1 >= 16, <= 512, integer;
var u1_1 >= 1, <= 512, integer;
subject to c_uf1_1:
	u1_1 * x1_1 == 512;
var DSP_1, integer;
subject to c_DSP1:
	DSP_1 == 0;
var x8_0 >= 16, <= 512, integer;
var u8_0 >= 1, <= 512, integer;
subject to c_uf8_0:
	u8_0 * x8_0 == 512;
var x8_1 >= 16, <= 256, integer;
var u8_1 >= 1, <= 256, integer;
subject to c_uf8_1:
	u8_1 * x8_1 == 256;
var DSP_8, integer;
subject to c_DSP8:
...
subject to c_uf10_0:
	u10_0 * x10_0 == 8;
var x10_1 >= 16, <= 256, integer;
var u10_1 >= 1, <= 256, integer;
subject to c_uf10_1:
	u10_1 * x10_1 == 256;
var x10_2 >= 10, <= 10, integer;
var u10_2 >= 1, <= 10, integer;
subject to c_uf10_2:
	u10_2 * x10_2 == 10;
var DSP_10, integer;
subject to c_DSP10:
...
subject to c_u2_0_u0_0:
	u2_0 == u0_0;
subject to c_u2_1_u0_2:
	u2_1 == u0_2;
subject to c_u9_0_u7_0:
	u9_0 == u7_0;
subject to c_u9_1_u7_2:
	u9_1 == u7_2;
...
subject to c_u10_0_u9_0:
	u10_0 == u9_0;
subject to c_u10_1_u9_1:
	u10_1 == u9_1;
subject to c_u10_1_u11_1:
	u10_1 == u11_1;
subject to c_u10_2_u11_0:
	u10_2 == u11_0;
...
subject to cst_rlr1_0:
	rlr1_0 == st0 + ((0 + (x0_2 - 1) * 1 * 1 + (x0_1 - 1) * 1 * 1 * x0_2 + 0 * 1 * 1 * x0_2 * x0_1)) * 1 * b0_0;
# epilogues
var ep1_0, integer;
subject to cep1_0:
	ep1_0 ==  + ((0 + (x0_2 - 1) * 1 * 1 + (x0_1 - 1) * 1 * 1 * x0_2 + (x0_0 - 1) * 1 * 1 * x0_2 * x0_1)) * 1 * b0_0 - ((0 + (x0_2 - 1) * 1 * 1 + (x0_1 - 1) * 1 * 1 * x0_2 + 0 * 1 * 1 * x0_2 * x0_1)) * 1 * b0_0;
# inputs last read/write dependencies
var lt1_0, integer;
subject to clt1_0:
...
subject to cst_rlr3_5:
	rlr3_5 == st5 + ((0 + 0 * 1 * 1 + (x5_1 - 1) * 1 * 1 * x5_2 + (x5_0 - 1) * 1 * 1 * x5_2 * x5_1)) * 1 * b5_0;
var rlr6_5, integer;
subject to cst_rlr6_5:
	rlr6_5 == st5 + ((0 + (x5_2 - 1) * 1 * 1 + (x5_1 - 1) * 1 * 1 * x5_2 + 0 * 1 * 1 * x5_2 * x5_1)) * 1 * b5_0;
# epilogues
var ep3_5, integer;
subject to cep3_5:
	ep3_5 ==  + ((0 + (x5_2 - 1) * 1 * 1 + (x5_1 - 1) * 1 * 1 * x5_2 + (x5_0 - 1) * 1 * 1 * x5_2 * x5_1)) * 1 * b5_0 - ((0 + 0 * 1 * 1 + (x5_1 - 1) * 1 * 1 * x5_2 + (x5_0 - 1) * 1 * 1 * x5_2 * x5_1)) * 1 * b5_0;
var ep6_5, integer;
subject to cep6_5:
	ep6_5 ==  + ((0 + (x5_2 - 1) * 1 * 1 + (x5_1 - 1) * 1 * 1 * x5_2 + (x5_0 - 1) * 1 * 1 * x5_2 * x5_1)) * 1 * b5_0 - ((0 + (x5_2 - 1) * 1 * 1 + (x5_1 - 1) * 1 * 1 * x5_2 + 0 * 1 * 1 * x5_2 * x5_1)) * 1 * b5_0;
# inputs last read/write dependencies
var lt3_5, integer;
subject to clt3_5:
...
subject to cst_rlr4_7:
	rlr4_7 == st7 + ((0 + 0 * 1 * 1 + (x7_1 - 1) * 1 * 1 * x7_2 + (x7_0 - 1) * 1 * 1 * x7_2 * x7_1)) * 1 * b7_0;
var rlr8_7, integer;
subject to cst_rlr8_7:
	rlr8_7 == st7 + ((0 + (x7_2 - 1) * 1 * 1 + (x7_1 - 1) * 1 * 1 * x7_2 + 0 * 1 * 1 * x7_2 * x7_1)) * 1 * b7_0;
# epilogues
var ep4_7, integer;
subject to cep4_7:
	ep4_7 ==  + ((0 + (x7_2 - 1) * 1 * 1 + (x7_1 - 1) * 1 * 1 * x7_2 + (x7_0 - 1) * 1 * 1 * x7_2 * x7_1)) * 1 * b7_0 - ((0 + 0 * 1 * 1 + (x7_1 - 1) * 1 * 1 * x7_2 + (x7_0 - 1) * 1 * 1 * x7_2 * x7_1)) * 1 * b7_0;
var ep8_7, integer;
subject to cep8_7:
	ep8_7 ==  + ((0 + (x7_2 - 1) * 1 * 1 + (x7_1 - 1) * 1 * 1 * x7_2 + (x7_0 - 1) * 1 * 1 * x7_2 * x7_1)) * 1 * b7_0 - ((0 + (x7_2 - 1) * 1 * 1 + (x7_1 - 1) * 1 * 1 * x7_2 + 0 * 1 * 1 * x7_2 * x7_1)) * 1 * b7_0;
# inputs last read/write dependencies
var lt4_7, integer;
subject to clt4_7:
...
var fw7, integer;
subject to cfw7:
	fw7 == st7 + ((0 + 0 * 1 * 1 + (x7_1 - 1) * 1 * 1 * x7_2 + 0 * 1 * 1 * x7_2 * x7_1)) * 1 * b7_0;
# node: 9 info
# start time
var st9, integer;
subject to cst_st9:
...
var st10, integer;
subject to cst_st10:
	st10 == max( + fw9*b9_0*b10_0,  + lw11*b11_0*b10_0);
# relative last reads
var rlr9_10, integer;
subject to cst_rlr9_10:
	rlr9_10 == st10 + ((0 + 0 * 1 * 1 + (x10_1 - 1) * 1 * 1 * x10_2 + (x10_0 - 1) * 1 * 1 * x10_2 * x10_1)) * 1 * b10_0;
var rlr11_10, integer;
subject to cst_rlr11_10:
	rlr11_10 == st10 + ((0 + (x10_2 - 1) * 1 * 1 + (x10_1 - 1) * 1 * 1 * x10_2 + 0 * 1 * 1 * x10_2 * x10_1)) * 1 * b10_0;
# epilogues
var ep9_10, integer;
subject to cep9_10:
	ep9_10 ==  + ((0 + (x10_2 - 1) * 1 * 1 + (x10_1 - 1) * 1 * 1 * x10_2 + (x10_0 - 1) * 1 * 1 * x10_2 * x10_1)) * 1 * b10_0 - ((0 + 0 * 1 * 1 + (x10_1 - 1) * 1 * 1 * x10_2 + (x10_0 - 1) * 1 * 1 * x10_2 * x10_1)) * 1 * b10_0;
var ep11_10, integer;
subject to cep11_10:
	ep11_10 ==  + ((0 + (x10_2 - 1) * 1 * 1 + (x10_1 - 1) * 1 * 1 * x10_2 + (x10_0 - 1) * 1 * 1 * x10_2 * x10_1)) * 1 * b10_0 - ((0 + (x10_2 - 1) * 1 * 1 + (x10_1 - 1) * 1 * 1 * x10_2 + 0 * 1 * 1 * x10_2 * x10_1)) * 1 * b10_0;
# inputs last read/write dependencies
var lt9_10, integer;
subject to clt9_10:
...
var fw10, integer;
subject to cfw10:
	fw10 == st10 + ((0 + 0 * 1 * 1 + (x10_1 - 1) * 1 * 1 * x10_2 + 0 * 1 * 1 * x10_2 * x10_1)) * 1 * b10_0;
# node: 12 info
# start time
var st12, integer;
subject to cst_st12:
