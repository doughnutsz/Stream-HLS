...
module attributes {torch.debug_module_name = "MultiHeadSelfAttention"} {
  func.func @node0(%arg0: !dataflow.stream<f32, 8192>, %arg1: memref<1x64x128xf32>) {
    affine.for %arg2 = 0 to 64 {
      affine.for %arg3 = 0 to 128 {
        ...
        affine.store %0, %arg1[0, %arg2, %arg3] : memref<1x64x128xf32>
  ...
  func.func @node2(%arg0: memref<128x128xf32>, %arg1: !dataflow.stream<f32, 8192>, %arg2: !dataflow.stream<f32, 8192>, %arg3: f32) {
      ...
      affine.for %arg5 = 0 to 128 {
        affine.for %arg6 = 0 to 128 {
          affine.if #set(%arg5) {
            ...
            affine.store %5, %alloc_1[%arg4, %arg6] : memref<64x128xf32>
          }
          %0 = affine.load %alloc_1[%arg4, %arg6] : memref<64x128xf32>
          affine.if #set(%arg4) {
            %5 = affine.load %arg0[%arg6, %arg5] : memref<128x128xf32>
            affine.store %5, %alloc_0[%arg6, %arg5] : memref<128x128xf32>
          }
          %1 = affine.load %alloc_0[%arg6, %arg5] : memref<128x128xf32>
          affine.if #set(%arg6) {
            affine.store %arg3, %alloc[%arg4, %arg5] : memref<64x128xf32>
          }
          %2 = affine.load %alloc[%arg4, %arg5] : memref<64x128xf32>
          %3 = arith.mulf %0, %1 : f32
          %4 = arith.addf %2, %3 : f32
          affine.store %4, %alloc[%arg4, %arg5] : memref<64x128xf32>
          affine.if #set1(%arg6) {
            %5 = affine.load %alloc[%arg4, %arg5] : memref<64x128xf32>
  ...
  func.func @node4(%arg0: memref<64x8x16xf32>, %arg1: !dataflow.stream<f32, 8192>) {
    affine.for %arg2 = 0 to 64 {
      affine.for %arg3 = 0 to 128 {
        %0 = affine.load %arg0[%arg2, %arg3 floordiv 16, %arg3 mod 16] : memref<64x8x16xf32>
  ...
  func.func @node6(%arg0: memref<8x64x16xf32>, %arg1: !dataflow.stream<f32, 32768>, %arg2: memref<8x64x16xf32>, %arg3: f32) {
        ...
        affine.for %arg6 = 0 to 16 {
          affine.for %arg7 = 0 to 64 {
            affine.if #set(%arg6) {
              ...
              affine.store %5, %alloc_1[%arg4, %arg5, %arg7] : memref<8x64x64xf32>
            }
            %0 = affine.load %alloc_1[%arg4, %arg5, %arg7] : memref<8x64x64xf32>
            affine.if #set(%arg5) {
              %5 = affine.load %arg0[%arg4, %arg7, %arg6] : memref<8x64x16xf32>
              affine.store %5, %alloc_0[%arg4, %arg7, %arg6] : memref<8x64x16xf32>
            }
            %1 = affine.load %alloc_0[%arg4, %arg7, %arg6] : memref<8x64x16xf32>
            affine.if #set(%arg7) {
              affine.store %arg3, %alloc[%arg4, %arg5, %arg6] : memref<8x64x16xf32>
            }
            %2 = affine.load %alloc[%arg4, %arg5, %arg6] : memref<8x64x16xf32>
            %3 = arith.mulf %0, %1 : f32
            %4 = arith.addf %2, %3 : f32
            affine.store %4, %alloc[%arg4, %arg5, %arg6] : memref<8x64x16xf32>
            affine.if #set2(%arg7) {
              %5 = affine.load %alloc[%arg4, %arg5, %arg6] : memref<8x64x16xf32>
              affine.store %5, %arg2[%arg4, %arg5, %arg6] : memref<8x64x16xf32>
            }
          } {loop_directive = #dataflow.pipeline_ii<pipeline=true, targetII=1, dataflow=false, flatten=false>}
        }
      }
  ...
  func.func @node7(%arg0: memref<64x128xf32>, %arg1: memref<8x64x16xf32>) {
    affine.for %arg2 = 0 to 8 {
      affine.for %arg3 = 0 to 64 {
        affine.for %arg4 = 0 to 16 {
          %0 = affine.load %arg0[%arg3, %arg2 * 16 + %arg4] : memref<64x128xf32>
          affine.store %0, %arg1[%arg2, %arg3, %arg4] : memref<8x64x16xf32>
        } {loop_directive = #dataflow.pipeline_ii<pipeline=true, targetII=1, dataflow=false, flatten=false>}
      }
    }
    return
  ...
  func.func @node13(%arg0: !dataflow.stream<f32, 8192>, %arg1: memref<8x16x64xf32>, %arg2: !dataflow.stream<f32, 32768>, %arg3: f32) {
        ...
        affine.for %arg6 = 0 to 64 {
          affine.for %arg7 = 0 to 16 {
            affine.if #set(%arg6) {
              ...
              affine.store %5, %alloc_1[%arg4, %arg5, %arg7] : memref<8x64x16xf32>
            }
            %0 = affine.load %alloc_1[%arg4, %arg5, %arg7] : memref<8x64x16xf32>
            affine.if #set(%arg5) {
              %5 = affine.load %arg1[%arg4, %arg7, %arg6] : memref<8x16x64xf32>
              affine.store %5, %alloc_0[%arg4, %arg7, %arg6] : memref<8x16x64xf32>
            }
            %1 = affine.load %alloc_0[%arg4, %arg7, %arg6] : memref<8x16x64xf32>
            affine.if #set(%arg7) {
              affine.store %arg3, %alloc[%arg4, %arg5, %arg6] : memref<8x64x64xf32>
            }
            %2 = affine.load %alloc[%arg4, %arg5, %arg6] : memref<8x64x64xf32>
            %3 = arith.mulf %0, %1 : f32
            %4 = arith.addf %2, %3 : f32
            affine.store %4, %alloc[%arg4, %arg5, %arg6] : memref<8x64x64xf32>
            affine.if #set3(%arg7) {
              %5 = affine.load %alloc[%arg4, %arg5, %arg6] : memref<8x64x64xf32>
  ...
  func.func @node14(%arg0: memref<64x128xf32>, %arg1: memref<8x16x64xf32>) {
    affine.for %arg2 = 0 to 8 {
      affine.for %arg3 = 0 to 16 {
        affine.for %arg4 = 0 to 64 {
          %0 = affine.load %arg0[%arg4, %arg2 * 16 + %arg3] : memref<64x128xf32>
          affine.store %0, %arg1[%arg2, %arg3, %arg4] : memref<8x16x64xf32>
        } {loop_directive = #dataflow.pipeline_ii<pipeline=true, targetII=1, dataflow=false, flatten=false>}
      }
    }
    return
  ...
  func.func @node17(%arg0: !dataflow.stream<f32, 8192>, %arg1: memref<128x128xf32>, %arg2: !dataflow.stream<f32, 8192>, %arg3: f32) {
    %alloc = memref.alloc() {alignment = 64 : i64} : memref<64x128xf32>
    %alloc_0 = memref.alloc() {alignment = 64 : i64} : memref<128x128xf32>
    %alloc_1 = memref.alloc() {alignment = 64 : i64} : memref<64x128xf32>
    affine.for %arg4 = 0 to 64 {
      affine.for %arg5 = 0 to 128 {
        affine.for %arg6 = 0 to 128 {
          ...
          %0 = affine.load %alloc_1[%arg4, %arg6] : memref<64x128xf32>
          affine.if #set(%arg4) {
            %5 = affine.load %arg1[%arg6, %arg5] : memref<128x128xf32>
            affine.store %5, %alloc_0[%arg6, %arg5] : memref<128x128xf32>
          }
          %1 = affine.load %alloc_0[%arg6, %arg5] : memref<128x128xf32>
          affine.if #set(%arg6) {
  ...
  func.func @node18(%arg0: memref<128x128xf32>, %arg1: memref<128x128xf32>) {
    affine.for %arg2 = 0 to 128 {
      affine.for %arg3 = 0 to 128 {
        %0 = affine.load %arg0[%arg3, %arg2] : memref<128x128xf32>
        affine.store %0, %arg1[%arg2, %arg3] : memref<128x128xf32>
  ...
  func.func @node20(%arg0: memref<128x128xf32>, %arg1: !dataflow.stream<f32, 8192>, %arg2: !dataflow.stream<f32, 8192>, %arg3: f32) {
    %alloc = memref.alloc() {alignment = 64 : i64} : memref<64x128xf32>
    %alloc_0 = memref.alloc() {alignment = 64 : i64} : memref<128x128xf32>
    %alloc_1 = memref.alloc() {alignment = 64 : i64} : memref<64x128xf32>
    affine.for %arg4 = 0 to 64 {
  ...
  func.func @node21(%arg0: memref<128x128xf32>, %arg1: memref<128x128xf32>) {
    affine.for %arg2 = 0 to 128 {
      affine.for %arg3 = 0 to 128 {
        %0 = affine.load %arg0[%arg3, %arg2] : memref<128x128xf32>
        affine.store %0, %arg1[%arg2, %arg3] : memref<128x128xf32>
  ...
  func.func @node23(%arg0: !dataflow.stream<f32, 8192>, %arg1: memref<128x128xf32>, %arg2: !dataflow.stream<f32, 8192>, %arg3: f32) {
    %alloc = memref.alloc() {alignment = 64 : i64} : memref<64x128xf32>
    %alloc_0 = memref.alloc() {alignment = 64 : i64} : memref<128x128xf32>
    %alloc_1 = memref.alloc() {alignment = 64 : i64} : memref<64x128xf32>
    affine.for %arg4 = 0 to 64 {
  ...
  func.func @node24(%arg0: memref<128x128xf32>, %arg1: memref<128x128xf32>) {
    affine.for %arg2 = 0 to 128 {
      affine.for %arg3 = 0 to 128 {
        %0 = affine.load %arg0[%arg3, %arg2] : memref<128x128xf32>
        affine.store %0, %arg1[%arg2, %arg3] : memref<128x128xf32>
  ...
  func.func @forward(%arg0: memref<1x64x128xf32>, %arg1: memref<128xf32>, %arg2: memref<128x128xf32>, %arg3: memref<128xf32>, %arg4: memref<128x128xf32>, %arg5: memref<128xf32>, %arg6: memref<128x128xf32>, %arg7: memref<128xf32>, %arg8: memref<128x128xf32>, %arg9: memref<1x64x128xf32>) {
    ...
    %alloc_5 = memref.alloc() {alignment = 64 : i64} : memref<8x16x64xf32>
    ...
    %alloc_7 = memref.alloc() {alignment = 64 : i64} : memref<128x128xf32>
    ...
    %alloc_10 = memref.alloc() {alignment = 64 : i64} : memref<64x128xf32>
    %14 = dataflow.stream {depth = 8192 : i32} : <f32, 8192>
    %alloc_11 = memref.alloc() {alignment = 64 : i64} : memref<128x128xf32>
    ...
    call @node25(%arg0, %17, %16, %15) : (memref<1x64x128xf32>, !dataflow.stream<f32, 8192>, !dataflow.stream<f32, 8192>, !dataflow.stream<f32, 8192>) -> ()
    call @node24(%arg2, %alloc_11) : (memref<128x128xf32>, memref<128x128xf32>) -> ()
    call @node23(%15, %alloc_11, %14, %cst_0) : (!dataflow.stream<f32, 8192>, memref<128x128xf32>, !dataflow.stream<f32, 8192>, f32) -> ()
    call @node22(%14, %arg1, %alloc_10) : (!dataflow.stream<f32, 8192>, memref<128xf32>, memref<64x128xf32>) -> ()
    call @node21(%arg4, %alloc_9) : (memref<128x128xf32>, memref<128x128xf32>) -> ()
    call @node20(%alloc_9, %16, %13, %cst_0) : (memref<128x128xf32>, !dataflow.stream<f32, 8192>, !dataflow.stream<f32, 8192>, f32) -> ()
    call @node19(%13, %arg3, %alloc_8) : (!dataflow.stream<f32, 8192>, memref<128xf32>, memref<64x128xf32>) -> ()
    call @node18(%arg6, %alloc_7) : (memref<128x128xf32>, memref<128x128xf32>) -> ()
    call @node17(%17, %alloc_7, %12, %cst_0) : (!dataflow.stream<f32, 8192>, memref<128x128xf32>, !dataflow.stream<f32, 8192>, f32) -> ()
    call @node16(%12, %arg5, %alloc_6) : (!dataflow.stream<f32, 8192>, memref<128xf32>, memref<64x128xf32>) -> ()
    call @node15(%alloc_10, %11) : (memref<64x128xf32>, !dataflow.stream<f32, 8192>) -> ()
    call @node14(%alloc_8, %alloc_5) : (memref<64x128xf32>, memref<8x16x64xf32>) -> ()
    call @node13(%11, %alloc_5, %10, %cst_0) : (!dataflow.stream<f32, 8192>, memref<8x16x64xf32>, !dataflow.stream<f32, 32768>, f32) -> ()
    ...
    call @node7(%alloc_6, %alloc_4) : (memref<64x128xf32>, memref<8x64x16xf32>) -> ()
    call @node6(%alloc_4, %3, %alloc_3, %cst_0) : (memref<8x64x16xf32>, !dataflow.stream<f32, 32768>, memref<8x64x16xf32>, f32) -> ()
    ...
    call @node2(%alloc, %2, %1, %cst_0) : (memref<128x128xf32>, !dataflow.stream<f32, 8192>, !dataflow.stream<f32, 8192>, f32) -> ()
