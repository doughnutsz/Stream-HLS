...
var st0, integer;
subject to cst_st0:
	st0 == max( + fw1*b1_0*b0_0,  + lw2*b2_0*b0_0);
# relative last reads
var rlr1_0, integer;
...
var ep2_0, integer;
subject to cep2_0:
	ep2_0 ==  + ((0 + (x0_2 - 1) * 1 * 1 + (x0_1 - 1) * 1 * 1 * x0_2 + (x0_0 - 1) * 1 * 1 * x0_2 * x0_1)) * 4 * b0_0 - ((0 + (x0_2 - 1) * 1 * 1 + (x0_1 - 1) * 1 * 1 * x0_2 + 0 * 1 * 1 * x0_2 * x0_1)) * 4 * b0_0;
# inputs last read/write dependencies
var lt1_0, integer;
subject to clt1_0:
...
var st4, integer;
subject to cst_st4:
	st4 == max( + fw3*b3_0*b4_0,  + lw5*b5_0*b4_0);
# relative last reads
var rlr3_4, integer;
...
subject to cst_rlr5_4:
	rlr5_4 == st4 + ((0 + (x4_2 - 1) * 1 * 1 + (x4_1 - 1) * 1 * 1 * x4_2 + 0 * 1 * 1 * x4_2 * x4_1)) * 4 * b4_0;
# epilogues
var ep3_4, integer;
subject to cep3_4:
...
var ep5_4, integer;
subject to cep5_4:
	ep5_4 ==  + ((0 + (x4_2 - 1) * 1 * 1 + (x4_1 - 1) * 1 * 1 * x4_2 + (x4_0 - 1) * 1 * 1 * x4_2 * x4_1)) * 4 * b4_0 - ((0 + (x4_2 - 1) * 1 * 1 + (x4_1 - 1) * 1 * 1 * x4_2 + 0 * 1 * 1 * x4_2 * x4_1)) * 4 * b4_0;
# inputs last read/write dependencies
var lt3_4, integer;
subject to clt3_4:
