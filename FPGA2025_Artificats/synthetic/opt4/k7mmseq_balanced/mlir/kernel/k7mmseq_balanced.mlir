...
module attributes {torch.debug_module_name = "k7mmseq"} {
  ...
  func.func @node1(%arg0: memref<64x64xf32, #map>, %arg1: tensor<4x4x!dataflow.stream<f32, 256>>, %arg2: tensor<4x4x!dataflow.stream<f32, 256>>, %arg3: f32) {
          ...
          affine.for %arg7 = 0 to 4 {
            affine.for %arg8 = 0 to 4 {
              affine.for %arg9 = 0 to 4 {
                ...
                %0 = affine.load %alloc_0[%arg7 + %arg4 * 4, %arg8 + %arg5 * 4] : memref<64x64xf32, #map>
                %1 = affine.load %arg0[%arg8 + %arg5 * 4, %arg9 + %arg6 * 4] : memref<64x64xf32, #map>
  ...
  func.func @node2(%arg0: memref<64x64xf32, #map>, %arg1: tensor<4x4x!dataflow.stream<f32, 256>>, %arg2: tensor<4x4x!dataflow.stream<f32, 256>>, %arg3: f32) {
    %alloc = memref.alloc() {alignment = 64 : i64} : memref<64x64xf32, #map>
    %alloc_0 = memref.alloc() {alignment = 64 : i64} : memref<64x64xf32, #map>
    affine.for %arg4 = 0 to 16 {
      affine.for %arg5 = 0 to 16 {
  ...
  func.func @node3(%arg0: memref<64x64xf32, #map>, %arg1: tensor<4x4x!dataflow.stream<f32, 256>>, %arg2: tensor<4x4x!dataflow.stream<f32, 256>>, %arg3: f32) {
    %alloc = memref.alloc() {alignment = 64 : i64} : memref<64x64xf32, #map>
    %alloc_0 = memref.alloc() {alignment = 64 : i64} : memref<64x64xf32, #map>
    affine.for %arg4 = 0 to 16 {
      affine.for %arg5 = 0 to 16 {
          ...
          affine.for %arg7 = 0 to 4 {
            affine.for %arg8 = 0 to 4 {
              affine.for %arg9 = 0 to 4 {
                ...
                %0 = affine.load %alloc_0[%arg7 + %arg4 * 4, %arg8 + %arg5 * 4] : memref<64x64xf32, #map>
                %1 = affine.load %arg1[%arg8 + %arg5 * 4, %arg9 + %arg6 * 4] : memref<64x64xf32, #map>
                affine.if #set(%arg8, %arg5) {
                  affine.store %arg3, %alloc[%arg7 + %arg4 * 4, %arg9 + %arg6 * 4] : memref<64x64xf32, #map>
                }
                %2 = affine.load %alloc[%arg7 + %arg4 * 4, %arg9 + %arg6 * 4] : memref<64x64xf32, #map>
  ...
  func.func @node6(%arg0: tensor<4x4x!dataflow.stream<f32, 256>>, %arg1: memref<64x64xf32, #map>, %arg2: tensor<4x4x!dataflow.stream<f32, 256>>, %arg3: f32) {
    %alloc = memref.alloc() {alignment = 64 : i64} : memref<64x64xf32, #map>
    %alloc_0 = memref.alloc() {alignment = 64 : i64} : memref<64x64xf32, #map>
    affine.for %arg4 = 0 to 16 {
      affine.for %arg5 = 0 to 16 {
      ...
      affine.for %arg5 = 0 to 16 {
        affine.for %arg6 = 0 to 16 {
          affine.for %arg7 = 0 to 4 {
            affine.for %arg8 = 0 to 4 {
              affine.for %arg9 = 0 to 4 {
                %0 = affine.load %arg1[%arg7 + %arg4 * 4, %arg8 + %arg5 * 4] : memref<64x64xf32, #map>
                %1 = affine.load %arg0[%arg8 + %arg5 * 4, %arg9 + %arg6 * 4] : memref<64x64xf32, #map>
                affine.if #set(%arg8, %arg5) {
                  affine.store %arg3, %alloc[%arg7 + %arg4 * 4, %arg9 + %arg6 * 4] : memref<64x64xf32, #map>
                }
  ...
  func.func @forward(%arg0: memref<64x64xf32, #map>, %arg1: memref<64x64xf32, #map>, %arg2: memref<64x64xf32, #map>, %arg3: memref<64x64xf32, #map>, %arg4: memref<64x64xf32, #map>, %arg5: memref<64x64xf32, #map>, %arg6: memref<64x64xf32, #map>, %arg7: memref<64x64xf32, #map>, %arg8: memref<64x64xf32, #map>) {
    ...
    call @node7(%arg1, %arg0, %6, %cst) : (memref<64x64xf32, #map>, memref<64x64xf32, #map>, tensor<4x4x!dataflow.stream<f32, 256>>, f32) -> ()
    call @node6(%6, %arg2, %5, %cst) : (tensor<4x4x!dataflow.stream<f32, 256>>, memref<64x64xf32, #map>, tensor<4x4x!dataflow.stream<f32, 256>>, f32) -> ()
    ...
    call @node3(%arg5, %3, %2, %cst) : (memref<64x64xf32, #map>, tensor<4x4x!dataflow.stream<f32, 256>>, tensor<4x4x!dataflow.stream<f32, 256>>, f32) -> ()
    call @node2(%arg6, %2, %1, %cst) : (memref<64x64xf32, #map>, tensor<4x4x!dataflow.stream<f32, 256>>, tensor<4x4x!dataflow.stream<f32, 256>>, f32) -> ()
    call @node1(%arg7, %1, %0, %cst) : (memref<64x64xf32, #map>, tensor<4x4x!dataflow.stream<f32, 256>>, tensor<4x4x!dataflow.stream<f32, 256>>, f32) -> ()
