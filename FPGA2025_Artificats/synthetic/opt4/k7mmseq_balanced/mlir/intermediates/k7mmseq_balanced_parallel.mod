...
subject to cst_rlr0_1:
	rlr0_1 == st1 + ((0 + 0 * 1 * 1 + (x1_1 - 1) * 1 * 1 * x1_2 + (x1_0 - 1) * 1 * 1 * x1_2 * x1_1)) * 1 * b1_0;
# epilogues
var ep0_1, integer;
subject to cep0_1:
	ep0_1 ==  + ((0 + (x1_2 - 1) * 1 * 1 + (x1_1 - 1) * 1 * 1 * x1_2 + (x1_0 - 1) * 1 * 1 * x1_2 * x1_1)) * 1 * b1_0 - ((0 + 0 * 1 * 1 + (x1_1 - 1) * 1 * 1 * x1_2 + (x1_0 - 1) * 1 * 1 * x1_2 * x1_1)) * 1 * b1_0;
# inputs last read/write dependencies
var lt0_1, integer;
subject to clt0_1:
...
var fw1, integer;
subject to cfw1:
	fw1 == st1 + ((0 + 0 * 1 * 1 + (x1_1 - 1) * 1 * 1 * x1_2 + 0 * 1 * 1 * x1_2 * x1_1)) * 1 * b1_0;
# node: 2 info
# start time
var st2, integer;
subject to cst_st2:
