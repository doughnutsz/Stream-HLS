...
module attributes {torch.debug_module_name = "k7mmseq"} {
          ...
          affine.for %arg7 = 0 to 4 {
            affine.for %arg8 = 0 to 4 {
              affine.for %arg9 = 0 to 4 {
                ...
                %1 = affine.load %arg0[%arg8 + %arg5 * 4, %arg9 + %arg6 * 4] : memref<128x64xf32, #map4>
                affine.if #set3(%arg8, %arg5) {
          ...
          affine.for %arg7 = 0 to 4 {
            affine.for %arg8 = 0 to 8 {
              affine.for %arg9 = 0 to 4 {
                ...
                %1 = affine.load %arg1[%arg8 + %arg5 * 8, %arg9 + %arg6 * 4] : memref<128x128xf32, #map5>
          ...
          affine.for %arg7 = 0 to 4 {
            affine.for %arg8 = 0 to 4 {
              affine.for %arg9 = 0 to 8 {
                ...
                %0 = affine.load %alloc_0[%arg7 + %arg4 * 4, %arg8 + %arg5 * 4] : memref<64x64xf32, #map4>
                %1 = affine.load %arg0[%arg8 + %arg5 * 4, %arg9 + %arg6 * 8] : memref<64x128xf32, #map6>
                affine.if #set3(%arg8, %arg5) {
  ...
  func.func @node6(%arg0: memref<64x64xf32, #map4>, %arg1: tensor<4x4x!dataflow.stream<f32, 256>>, %arg2: tensor<4x4x!dataflow.stream<f32, 256>>, %arg3: f32) {
    %alloc = memref.alloc() {alignment = 64 : i64} : memref<64x64xf32, #map4>
    %alloc_0 = memref.alloc() {alignment = 64 : i64} : memref<64x64xf32, #map4>
    affine.for %arg4 = 0 to 16 {
      affine.for %arg5 = 0 to 16 {
          ...
          affine.for %arg7 = 0 to 4 {
            affine.for %arg8 = 0 to 4 {
              affine.for %arg9 = 0 to 4 {
                ...
                %1 = affine.load %arg0[%arg9 + %arg6 * 4, %arg8 + %arg5 * 4] : memref<64x64xf32, #map4>
                affine.if #set3(%arg9, %arg6) {
  ...
  func.func @node7(%arg0: memref<64x32xf32, #map3>, %arg1: memref<32x64xf32, #map7>, %arg2: tensor<4x4x!dataflow.stream<f32, 256>>, %arg3: f32) {
    %alloc = memref.alloc() {alignment = 64 : i64} : memref<64x64xf32, #map4>
    affine.for %arg4 = 0 to 16 {
      affine.for %arg5 = 0 to 16 {
        affine.for %arg6 = 0 to 16 {
          affine.for %arg7 = 0 to 4 {
            affine.for %arg8 = 0 to 4 {
              affine.for %arg9 = 0 to 2 {
                %0 = affine.load %arg0[%arg7 + %arg4 * 4, %arg9 + %arg6 * 2] : memref<64x32xf32, #map3>
                %1 = affine.load %arg1[%arg9 + %arg6 * 2, %arg8 + %arg5 * 4] : memref<32x64xf32, #map7>
                affine.if #set1(%arg9, %arg6) {
                  affine.store %arg3, %alloc[%arg7 + %arg4 * 4, %arg8 + %arg5 * 4] : memref<64x64xf32, #map4>
                }
                %2 = affine.load %alloc[%arg7 + %arg4 * 4, %arg8 + %arg5 * 4] : memref<64x64xf32, #map4>
  ...
  func.func @forward(%arg0: memref<64x32xf32, #map3>, %arg1: memref<32x64xf32, #map7>, %arg2: memref<64x64xf32, #map4>, %arg3: memref<64x128xf32, #map6>, %arg4: memref<128x128xf32, #map5>, %arg5: memref<128x64xf32, #map4>, %arg6: memref<64x32xf32, #map3>, %arg7: memref<32x16xf32, #map2>, %arg8: memref<64x16xf32, #map>) {
    ...
    call @node7(%arg0, %arg1, %6, %cst) : (memref<64x32xf32, #map3>, memref<32x64xf32, #map7>, tensor<4x4x!dataflow.stream<f32, 256>>, f32) -> ()
    call @node6(%arg2, %6, %5, %cst) : (memref<64x64xf32, #map4>, tensor<4x4x!dataflow.stream<f32, 256>>, tensor<4x4x!dataflow.stream<f32, 256>>, f32) -> ()
