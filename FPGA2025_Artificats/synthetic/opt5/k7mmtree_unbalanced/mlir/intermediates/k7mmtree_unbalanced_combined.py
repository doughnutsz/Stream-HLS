...
# node: 3 info
# start time
st3 = (0 + fw10000*b10000_0*b3_1)
# relative first write times of inputs
rlr10000_3 = st3
# epilogues
ep10000_3 =  + ((1048575) * 1) * b3_1
# inputs last read/write dependencies
...
# node: 4 info
# start time
st4 = max(0 + fw3*b3_1*b4_1, 0 + fw5*b5_3*b4_1)
# relative first write times of inputs
rlr3_4 = st4 + ((131056) * 1) * b4_1
rlr5_4 = st4 + ((1023) * 1) * b4_1
# epilogues
ep3_4 =  + ((131071) * 1) * b4_1 - ((131056) * 1) * b4_1
ep5_4 =  + ((131071) * 1) * b4_1 - ((1023) * 1) * b4_1
# inputs last read/write dependencies
...
# node: 1 info
# start time
st1 = max(0 + fw0*b0_4*b1_4, 0 + fw2*b2_4*b1_4)
# relative first write times of inputs
rlr0_1 = st1 + ((4095) * 1) * b1_4
rlr2_1 = st1 + ((524224) * 1) * b1_4
# epilogues
ep0_1 =  + ((524287) * 1) * b1_4 - ((4095) * 1) * b1_4
ep2_1 =  + ((524287) * 1) * b1_4 - ((524224) * 1) * b1_4
# inputs last read/write dependencies
...
# relative first write times of inputs
rlr1_6 = st6 + ((130111) * 1) * b6_5
rlr4_6 = st6 + ((131008) * 1) * b6_5
# epilogues
ep1_6 =  + ((131071) * 1) * b6_5 - ((130111) * 1) * b6_5
ep4_6 =  + ((131071) * 1) * b6_5 - ((131008) * 1) * b6_5
# inputs last read/write dependencies
