...
st2 = (0 + fw1*b1_1*b2_1)
# relative first write times of inputs
rlr1_2 = st2 + ((262080) * 1) * b2_1
# epilogues
ep1_2 =  + ((262143) * 1) * b2_1 - ((262080) * 1) * b2_1
# inputs last read/write dependencies
...
st3 = (0 + fw2*b2_1*b3_1)
# relative first write times of inputs
rlr2_3 = st3 + ((262080) * 1) * b3_1
# epilogues
ep2_3 =  + ((262143) * 1) * b3_1 - ((262080) * 1) * b3_1
# inputs last read/write dependencies
...
st5 = (0 + fw4*b4_1*b5_1)
# relative first write times of inputs
rlr4_5 = st5 + ((262080) * 1) * b5_1
# epilogues
ep4_5 =  + ((262143) * 1) * b5_1 - ((262080) * 1) * b5_1
# inputs last read/write dependencies
...
st6 = (0 + fw5*b5_1*b6_1)
# relative first write times of inputs
rlr5_6 = st6 + ((262080) * 1) * b6_1
# epilogues
ep5_6 =  + ((262143) * 1) * b6_1 - ((262080) * 1) * b6_1
# inputs last read/write dependencies
