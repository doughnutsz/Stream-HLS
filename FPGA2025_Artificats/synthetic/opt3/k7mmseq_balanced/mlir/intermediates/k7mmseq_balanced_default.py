...
st2 = (0 + fw1*x1_0*x2_0)
# relative first write times of inputs
rlr1_2 = st2 + 1032444*x2_0
# epilogues
ep1_2 =  + 1048572*x2_0 - 1032444*x2_0
# inputs last read/write dependencies
...
st3 = (0 + fw2*x2_0*x3_0)
# relative first write times of inputs
rlr2_3 = st3 + 1032444*x3_0
# epilogues
ep2_3 =  + 1048572*x3_0 - 1032444*x3_0
# inputs last read/write dependencies
...
st4 = (0 + fw3*x3_0*x4_0)
# relative first write times of inputs
rlr3_4 = st4 + 1032444*x4_0
# epilogues
ep3_4 =  + 1048572*x4_0 - 1032444*x4_0
# inputs last read/write dependencies
...
st5 = (0 + fw4*x4_0*x5_0)
# relative first write times of inputs
rlr4_5 = st5 + 1032444*x5_0
# epilogues
ep4_5 =  + 1048572*x5_0 - 1032444*x5_0
# inputs last read/write dependencies
...
st6 = (0 + fw5*x5_0*x6_0)
# relative first write times of inputs
rlr5_6 = st6 + 1032444*x6_0
# epilogues
ep5_6 =  + 1048572*x6_0 - 1032444*x6_0
# inputs last read/write dependencies
