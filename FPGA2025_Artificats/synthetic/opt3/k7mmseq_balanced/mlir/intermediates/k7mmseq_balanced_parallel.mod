...
option gurobi_options 'lim:time=600 tech:logfile=k7mmseq_balanced_parallel.log';
param b0_0 := 1;
param b7_0 := 1;
param b2_0 := 1;
param b10000_0 := 1;
...
subject to c_uf0_1:
	u0_1 * x0_1 == 64;
var x0_2 >= 16, <= 64, integer;
var u0_2 >= 1, <= 64, integer;
subject to c_uf0_2:
	u0_2 * x0_2 == 64;
var DSP_0, integer;
subject to c_DSP0:
...
subject to c_uf4_0:
	u4_0 * x4_0 == 64;
var x4_1 >= 16, <= 64, integer;
var u4_1 >= 1, <= 64, integer;
subject to c_uf4_1:
	u4_1 * x4_1 == 64;
...
subject to c_uf3_1:
	u3_1 * x3_1 == 64;
var x3_2 >= 16, <= 64, integer;
var u3_2 >= 1, <= 64, integer;
subject to c_uf3_2:
	u3_2 * x3_2 == 64;
var DSP_3, integer;
subject to c_DSP3:
...
subject to c_uf5_1:
	u5_1 * x5_1 == 64;
var x5_2 >= 16, <= 64, integer;
var u5_2 >= 1, <= 64, integer;
subject to c_uf5_2:
	u5_2 * x5_2 == 64;
var DSP_5, integer;
subject to c_DSP5:
...
subject to cst_rlr3_4:
	rlr3_4 == st4 + ((0 + (x4_2 - 1) * 1 * 1 + 0 * 1 * 1 * x4_2 + (x4_0 - 1) * 1 * 1 * x4_2 * x4_1)) * 4 * b4_0;
# epilogues
var ep3_4, integer;
subject to cep3_4:
	ep3_4 ==  + ((0 + (x4_2 - 1) * 1 * 1 + (x4_1 - 1) * 1 * 1 * x4_2 + (x4_0 - 1) * 1 * 1 * x4_2 * x4_1)) * 4 * b4_0 - ((0 + (x4_2 - 1) * 1 * 1 + 0 * 1 * 1 * x4_2 + (x4_0 - 1) * 1 * 1 * x4_2 * x4_1)) * 4 * b4_0;
# inputs last read/write dependencies
var lt3_4, integer;
subject to clt3_4:
...
var fw4, integer;
subject to cfw4:
	fw4 == st4 + ((0 + (x4_2 - 1) * 1 * 1 + 0 * 1 * 1 * x4_2 + 0 * 1 * 1 * x4_2 * x4_1)) * 4 * b4_0;
# node: 5 info
# start time
var st5, integer;
subject to cst_st5:
...
subject to cst_rlr4_5:
	rlr4_5 == st5 + ((0 + (x5_2 - 1) * 1 * 1 + 0 * 1 * 1 * x5_2 + (x5_0 - 1) * 1 * 1 * x5_2 * x5_1)) * 4 * b5_0;
# epilogues
var ep4_5, integer;
subject to cep4_5:
	ep4_5 ==  + ((0 + (x5_2 - 1) * 1 * 1 + (x5_1 - 1) * 1 * 1 * x5_2 + (x5_0 - 1) * 1 * 1 * x5_2 * x5_1)) * 4 * b5_0 - ((0 + (x5_2 - 1) * 1 * 1 + 0 * 1 * 1 * x5_2 + (x5_0 - 1) * 1 * 1 * x5_2 * x5_1)) * 4 * b5_0;
# inputs last read/write dependencies
var lt4_5, integer;
subject to clt4_5:
