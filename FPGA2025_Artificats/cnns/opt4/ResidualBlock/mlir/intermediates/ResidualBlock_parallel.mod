...
option gurobi_options 'lim:time=1200 tech:logfile=ResidualBlock_parallel.log';
param b0_0 := 1;
param b7_0 := 1;
param b2_0 := 1;
param b10000_0 := 1;
...
subject to c_uf0_0:
	u0_0 * x0_0 == 16;
var x0_1 >= 8, <= 16, integer;
var u0_1 >= 1, <= 16, integer;
subject to c_uf0_1:
	u0_1 * x0_1 == 16;
...
subject to c_uf0_2:
	u0_2 * x0_2 == 56;
var x0_3 >= 3, <= 3, integer;
var u0_3 >= 1, <= 3, integer;
subject to c_uf0_3:
	u0_3 * x0_3 == 3;
...
subject to c_uf0_4:
	u0_4 * x0_4 == 3;
var x0_5 >= 8, <= 56, integer;
var u0_5 >= 1, <= 56, integer;
subject to c_uf0_5:
	u0_5 * x0_5 == 56;
var DSP_0, integer;
subject to c_DSP0:
...
subject to c_uf5_1:
	u5_1 * x5_1 == 56;
var x5_2 >= 8, <= 16, integer;
var u5_2 >= 1, <= 16, integer;
subject to c_uf5_2:
	u5_2 * x5_2 == 16;
var x5_3 >= 3, <= 3, integer;
var u5_3 >= 1, <= 3, integer;
subject to c_uf5_3:
	u5_3 * x5_3 == 3;
...
subject to c_uf5_4:
	u5_4 * x5_4 == 3;
var x5_5 >= 8, <= 56, integer;
var u5_5 >= 1, <= 56, integer;
subject to c_uf5_5:
	u5_5 * x5_5 == 56;
var DSP_5, integer;
subject to c_DSP5:
...
subject to c_u0_1_u1_0:
	u0_1 == u1_0;
subject to c_u0_2_u1_2:
	u0_2 == u1_2;
subject to c_u0_3_u1_1:
	u0_3 == u1_1;
subject to c_u0_1_u2_0:
	u0_1 == u2_0;
subject to c_u0_2_u2_2:
	u0_2 == u2_2;
subject to c_u0_3_u2_1:
	u0_3 == u2_1;
subject to c_u7_0_u5_0:
	u7_0 == u5_0;
subject to c_u7_1_u5_1:
	u7_1 == u5_1;
subject to c_u7_2_u5_5:
	u7_2 == u5_5;
...
subject to c_u3_1_u0_2:
	u3_1 == u0_2;
subject to c_u3_2_u0_5:
	u3_2 == u0_5;
subject to c_u5_2_u4_0:
	u5_2 == u4_0;
subject to c_u5_1_u4_1:
	u5_1 == u4_1;
subject to c_u5_3_u4_2:
	u5_3 == u4_2;
subject to c_u5_2_u6_0:
	u5_2 == u6_0;
subject to c_u5_1_u6_2:
	u5_1 == u6_2;
subject to c_u5_3_u6_1:
	u5_3 == u6_1;
...
subject to cst_rlr1_0:
	rlr1_0 == st0 + ((0 + (x0_5 - 1) * 1 * 1 + (x0_4 - 1) * 1 * 1 * x0_5 + (x0_3 - 1) * 1 * 1 * x0_5 * x0_4 + (x0_2 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 + (x0_1 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 * x0_2 + 0 * 1 * 1 * x0_5 * x0_4 * x0_3 * x0_2 * x0_1)) * 1 * b0_0;
var rlr2_0, integer;
subject to cst_rlr2_0:
	rlr2_0 == st0 + ((0 + (x0_5 - 1) * 1 * 1 + (x0_4 - 1) * 1 * 1 * x0_5 + (x0_3 - 1) * 1 * 1 * x0_5 * x0_4 + (x0_2 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 + (x0_1 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 * x0_2 + 0 * 1 * 1 * x0_5 * x0_4 * x0_3 * x0_2 * x0_1)) * 1 * b0_0;
# epilogues
var ep1_0, integer;
subject to cep1_0:
	ep1_0 ==  + ((0 + (x0_5 - 1) * 1 * 1 + (x0_4 - 1) * 1 * 1 * x0_5 + (x0_3 - 1) * 1 * 1 * x0_5 * x0_4 + (x0_2 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 + (x0_1 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 * x0_2 + (x0_0 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 * x0_2 * x0_1)) * 1 * b0_0 - ((0 + (x0_5 - 1) * 1 * 1 + (x0_4 - 1) * 1 * 1 * x0_5 + (x0_3 - 1) * 1 * 1 * x0_5 * x0_4 + (x0_2 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 + (x0_1 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 * x0_2 + 0 * 1 * 1 * x0_5 * x0_4 * x0_3 * x0_2 * x0_1)) * 1 * b0_0;
var ep2_0, integer;
subject to cep2_0:
	ep2_0 ==  + ((0 + (x0_5 - 1) * 1 * 1 + (x0_4 - 1) * 1 * 1 * x0_5 + (x0_3 - 1) * 1 * 1 * x0_5 * x0_4 + (x0_2 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 + (x0_1 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 * x0_2 + (x0_0 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 * x0_2 * x0_1)) * 1 * b0_0 - ((0 + (x0_5 - 1) * 1 * 1 + (x0_4 - 1) * 1 * 1 * x0_5 + (x0_3 - 1) * 1 * 1 * x0_5 * x0_4 + (x0_2 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 + (x0_1 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 * x0_2 + 0 * 1 * 1 * x0_5 * x0_4 * x0_3 * x0_2 * x0_1)) * 1 * b0_0;
# inputs last read/write dependencies
var lt1_0, integer;
subject to clt1_0:
...
var fw0, integer;
subject to cfw0:
	fw0 == st0 + ((0 + 0 * 1 * 1 + (x0_4 - 1) * 1 * 1 * x0_5 + (x0_3 - 1) * 1 * 1 * x0_5 * x0_4 + 0 * 1 * 1 * x0_5 * x0_4 * x0_3 + (x0_1 - 1) * 1 * 1 * x0_5 * x0_4 * x0_3 * x0_2 + 0 * 1 * 1 * x0_5 * x0_4 * x0_3 * x0_2 * x0_1)) * 1 * b0_0;
# node: 3 info
# start time
var st3, integer;
subject to cst_st3:
...
subject to cst_rlr4_5:
	rlr4_5 == st5 + ((0 + (x5_5 - 1) * 1 * 1 + (x5_4 - 1) * 1 * 1 * x5_5 + (x5_3 - 1) * 1 * 1 * x5_5 * x5_4 + (x5_2 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 + (x5_1 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 * x5_2 + 0 * 1 * 1 * x5_5 * x5_4 * x5_3 * x5_2 * x5_1)) * 1 * b5_0;
var rlr6_5, integer;
subject to cst_rlr6_5:
	rlr6_5 == st5 + ((0 + (x5_5 - 1) * 1 * 1 + (x5_4 - 1) * 1 * 1 * x5_5 + (x5_3 - 1) * 1 * 1 * x5_5 * x5_4 + (x5_2 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 + (x5_1 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 * x5_2 + 0 * 1 * 1 * x5_5 * x5_4 * x5_3 * x5_2 * x5_1)) * 1 * b5_0;
# epilogues
var ep4_5, integer;
subject to cep4_5:
	ep4_5 ==  + ((0 + (x5_5 - 1) * 1 * 1 + (x5_4 - 1) * 1 * 1 * x5_5 + (x5_3 - 1) * 1 * 1 * x5_5 * x5_4 + (x5_2 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 + (x5_1 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 * x5_2 + (x5_0 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 * x5_2 * x5_1)) * 1 * b5_0 - ((0 + (x5_5 - 1) * 1 * 1 + (x5_4 - 1) * 1 * 1 * x5_5 + (x5_3 - 1) * 1 * 1 * x5_5 * x5_4 + (x5_2 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 + (x5_1 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 * x5_2 + 0 * 1 * 1 * x5_5 * x5_4 * x5_3 * x5_2 * x5_1)) * 1 * b5_0;
var ep6_5, integer;
subject to cep6_5:
	ep6_5 ==  + ((0 + (x5_5 - 1) * 1 * 1 + (x5_4 - 1) * 1 * 1 * x5_5 + (x5_3 - 1) * 1 * 1 * x5_5 * x5_4 + (x5_2 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 + (x5_1 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 * x5_2 + (x5_0 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 * x5_2 * x5_1)) * 1 * b5_0 - ((0 + (x5_5 - 1) * 1 * 1 + (x5_4 - 1) * 1 * 1 * x5_5 + (x5_3 - 1) * 1 * 1 * x5_5 * x5_4 + (x5_2 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 + (x5_1 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 * x5_2 + 0 * 1 * 1 * x5_5 * x5_4 * x5_3 * x5_2 * x5_1)) * 1 * b5_0;
# inputs last read/write dependencies
var lt4_5, integer;
subject to clt4_5:
...
var fw5, integer;
subject to cfw5:
	fw5 == st5 + ((0 + 0 * 1 * 1 + (x5_4 - 1) * 1 * 1 * x5_5 + (x5_3 - 1) * 1 * 1 * x5_5 * x5_4 + (x5_2 - 1) * 1 * 1 * x5_5 * x5_4 * x5_3 + 0 * 1 * 1 * x5_5 * x5_4 * x5_3 * x5_2 + 0 * 1 * 1 * x5_5 * x5_4 * x5_3 * x5_2 * x5_1)) * 1 * b5_0;
# node: 7 info
# start time
var st7, integer;
subject to cst_st7:
