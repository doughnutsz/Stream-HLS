          ...
          affine.for %arg7 = 0 to 2 {
            affine.for %arg8 = 0 to 1 {
              affine.for %arg9 = 0 to 2 {
                affine.store %cst_0, %alloc[%arg7 + %arg4 * 2, %arg9 + %arg6 * 2, %arg5 + %arg8] : memref<16x58x58xf32>
              }
            }
          }
      ...
      affine.for %arg5 = 0 to 56 {
        affine.for %arg6 = 0 to 28 {
          affine.for %arg7 = 0 to 2 {
            affine.for %arg8 = 0 to 1 {
              affine.for %arg9 = 0 to 2 {
                %4 = affine.load %arg0[0, %arg7 + %arg4 * 2, %arg9 + %arg6 * 2, %arg5 + %arg8] : memref<1x16x56x56xf32, #map>
                affine.store %4, %alloc[%arg7 + %arg4 * 2, %arg9 + %arg6 * 2 + 1, %arg5 + %arg8 + 1] : memref<16x58x58xf32>
              }
            }
          }
        } {loop_directive = #dataflow.pipeline_ii<pipeline=true, targetII=1, dataflow=false, flatten=false>}
                      ...
                      affine.for %arg13 = 0 to 1 {
                        affine.for %arg14 = 0 to 1 {
                          affine.for %arg15 = 0 to 1 {
                            %4 = affine.load %alloc[%arg11 + %arg5 * 2, %arg12 + %arg6 * 2 + %arg7 + %arg13, %arg9 + %arg15 + %arg8 + %arg14] : memref<16x58x58xf32>
                            %5 = affine.load %arg1[%arg10 + %arg4 * 2, %arg11 + %arg5 * 2, %arg7 + %arg13, %arg8 + %arg14] : memref<16x16x3x3xf32>
                            affine.if #set(%arg11, %arg5, %arg7, %arg13, %arg8, %arg14) {
                              affine.store %cst_0, %alloc_2[%arg10 + %arg4 * 2, %arg12 + %arg6 * 2, %arg9 + %arg15] : memref<16x56x56xf32>
                            }
                            %6 = affine.load %alloc_2[%arg10 + %arg4 * 2, %arg12 + %arg6 * 2, %arg9 + %arg15] : memref<16x56x56xf32>
                            %7 = arith.mulf %4, %5 : f32
                            %8 = arith.addf %6, %7 : f32
                            affine.store %8, %alloc_2[%arg10 + %arg4 * 2, %arg12 + %arg6 * 2, %arg9 + %arg15] : memref<16x56x56xf32>
                            affine.if #set1(%arg11, %arg5, %arg7, %arg13, %arg8, %arg14) {
                              %9 = affine.load %alloc_2[%arg10 + %arg4 * 2, %arg12 + %arg6 * 2, %arg9 + %arg15] : memref<16x56x56xf32>
                              dataflow.aofs_write %0[%arg10, %arg12, %arg15], %9 {map = #map2} : tensor<2x2x1x!dataflow.stream<f32, 12544>>, f32
                            }
                          }
                        }
                      }
      ...
      affine.for %arg5 = 0 to 58 {
        affine.for %arg6 = 0 to 29 {
          affine.for %arg7 = 0 to 2 {
            affine.for %arg8 = 0 to 1 {
              affine.for %arg9 = 0 to 2 {
                affine.store %cst_0, %alloc_3[%arg7 + %arg4 * 2, %arg9 + %arg6 * 2, %arg5 + %arg8] : memref<16x58x58xf32>
              }
            }
          }
        } {loop_directive = #dataflow.pipeline_ii<pipeline=true, targetII=1, dataflow=false, flatten=false>}
                      ...
                      affine.for %arg13 = 0 to 1 {
                        affine.for %arg14 = 0 to 1 {
                          affine.for %arg15 = 0 to 7 {
                            %4 = affine.load %alloc_3[%arg12 + %arg6 * 2, %arg11 + %arg5 * 2 + %arg7 + %arg13, %arg15 + %arg9 * 7 + %arg8 + %arg14] : memref<16x58x58xf32>
                            %5 = affine.load %arg2[%arg10 + %arg4 * 2, %arg12 + %arg6 * 2, %arg7 + %arg13, %arg8 + %arg14] : memref<16x16x3x3xf32>
                            affine.if #set(%arg12, %arg6, %arg7, %arg13, %arg8, %arg14) {
                              affine.store %cst_0, %alloc_4[%arg10 + %arg4 * 2, %arg11 + %arg5 * 2, %arg15 + %arg9 * 7] : memref<16x56x56xf32>
                            }
                            %6 = affine.load %alloc_4[%arg10 + %arg4 * 2, %arg11 + %arg5 * 2, %arg15 + %arg9 * 7] : memref<16x56x56xf32>
                            %7 = arith.mulf %4, %5 : f32
                            %8 = arith.addf %6, %7 : f32
                            affine.store %8, %alloc_4[%arg10 + %arg4 * 2, %arg11 + %arg5 * 2, %arg15 + %arg9 * 7] : memref<16x56x56xf32>
                            affine.if #set1(%arg12, %arg6, %arg7, %arg13, %arg8, %arg14) {
                              %9 = affine.load %alloc_4[%arg10 + %arg4 * 2, %arg11 + %arg5 * 2, %arg15 + %arg9 * 7] : memref<16x56x56xf32>
                              dataflow.aofs_write %2[%arg10, %arg11, %arg15], %9 {map = #map2} : tensor<2x2x7x!dataflow.stream<f32, 1792>>, f32
                            }
                          }
                        }
                      }
