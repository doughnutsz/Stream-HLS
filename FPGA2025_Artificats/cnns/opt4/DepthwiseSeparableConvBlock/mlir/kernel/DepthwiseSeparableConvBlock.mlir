                  ...
                  affine.for %arg11 = 0 to 1 {
                    affine.for %arg12 = 0 to 1 {
                      affine.for %arg13 = 0 to 1 {
                        %3 = affine.load %alloc[%arg8 + %arg13, %arg9 + %arg4 * 2 + %arg6 + %arg11, %arg10 + %arg5 * 14 + %arg7 + %arg12] : memref<8x114x114xf32>
                        %4 = affine.load %arg2[%arg8 + %arg13, %arg6 + %arg11, %arg7 + %arg12] : memref<8x3x3xf32>
                        affine.if #set(%arg6, %arg11, %arg7, %arg12) {
                          affine.store %cst_0, %alloc_2[%arg8 + %arg13, %arg9 + %arg4 * 2, %arg10 + %arg5 * 14] : memref<8x112x112xf32>
                        }
                        %5 = affine.load %alloc_2[%arg8 + %arg13, %arg9 + %arg4 * 2, %arg10 + %arg5 * 14] : memref<8x112x112xf32>
                        %6 = arith.mulf %3, %4 : f32
                        %7 = arith.addf %5, %6 : f32
                        affine.store %7, %alloc_2[%arg8 + %arg13, %arg9 + %arg4 * 2, %arg10 + %arg5 * 14] : memref<8x112x112xf32>
                        affine.if #set1(%arg6, %arg11, %arg7, %arg12) {
                          %8 = affine.load %alloc_2[%arg8 + %arg13, %arg9 + %arg4 * 2, %arg10 + %arg5 * 14] : memref<8x112x112xf32>
                          dataflow.aofs_write %0[%arg13, %arg9, %arg10], %8 {map = #map2} : tensor<1x2x14x!dataflow.stream<f32, 3584>>, f32
                        }
                      }
                    }
                  }
                ...
                affine.for %arg10 = 0 to 1 {
                  affine.for %arg11 = 0 to 1 {
                    affine.if #set2(%arg7, %arg11) {
                      %8 = dataflow.aofs_read %0[%arg10, %arg8, %arg9] {map = #map2} : (tensor<1x2x14x!dataflow.stream<f32, 3584>>) -> f32
                      affine.store %8, %alloc_3[%arg6 + %arg10, %arg8 + %arg4 * 2, %arg9 + %arg5 * 14] : memref<8x112x112xf32>
                    }
                    %3 = affine.load %alloc_3[%arg6 + %arg10, %arg8 + %arg4 * 2, %arg9 + %arg5 * 14] : memref<8x112x112xf32>
                    %4 = affine.load %arg1[%arg7 + %arg11, %arg6 + %arg10, 0, 0] : memref<8x8x1x1xf32>
                    affine.if #set2(%arg6, %arg10) {
                      affine.store %cst_0, %alloc_4[%arg7 + %arg11, %arg8 + %arg4 * 2, %arg9 + %arg5 * 14] : memref<8x112x112xf32>
                    }
                    %5 = affine.load %alloc_4[%arg7 + %arg11, %arg8 + %arg4 * 2, %arg9 + %arg5 * 14] : memref<8x112x112xf32>
                    %6 = arith.mulf %3, %4 : f32
                    %7 = arith.addf %5, %6 : f32
                    affine.store %7, %alloc_4[%arg7 + %arg11, %arg8 + %arg4 * 2, %arg9 + %arg5 * 14] : memref<8x112x112xf32>
                    affine.if #set3(%arg6, %arg10) {
                      %8 = affine.load %alloc_4[%arg7 + %arg11, %arg8 + %arg4 * 2, %arg9 + %arg5 * 14] : memref<8x112x112xf32>
                      dataflow.aofs_write %1[%arg11, %arg8, %arg9], %8 {map = #map2} : tensor<1x2x14x!dataflow.stream<f32, 3584>>, f32
                    }
                  }
                }
              }
